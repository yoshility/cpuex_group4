...
loop3.140.320:
	...
	fsw	fa0, 0(a6) 
	addi	a1, a1, -1
	jal	x0, loop3.140.320 
bg_else.641:
	jalr	x0, ra, 0
	addi	x0, x0, 0
loop2.147.327:
	addi	t5, x0, 0
	blt	a2, t5, bg_else.643
	addi	a6, a1, -1
	sw	a5, -0(fp)
	addi	sp, sp, -4
	sw	a4, -4(fp)
	...
	lw	a4, -4(fp)
	lw	a5, -0(fp)
	jal	x0, loop2.147.327 
bg_else.643:
	jalr	x0, ra, 0
	addi	x0, x0, 0
loop1.154.334:
	addi	t5, x0, 0
	blt	a0, t5, bg_else.645
	addi	a6, a2, -1
	sw	a5, -0(fp)
	addi	sp, sp, -4
	sw	a4, -4(fp)
