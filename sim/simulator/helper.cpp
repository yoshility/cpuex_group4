...
void clk_count(unsigned long long* clk, bool* pre_inst_is_load, int* pre_load_rd, int v1, int v2, bool next_flag, int next_rd, int* stall, int* input_clk, int* output_clk, bool busy) {
