...
beq_else.36339:
	...
	flw	fa1, 0(a5)
	fsw	fa0, -8(sp)
	sw	a1, -12(sp) # Save texture.5626.9618.15641
	sw	a3, -16(sp) # Save refltype.5629.9621.15647
	sw	a2, -20(sp) # Save form.5628.9620.15645
...
beq_else.36346:
	...
	fsw	fa0, 0(a2) 
beq_cont.36347:
	lw	a2, -20(sp) # Restore form.5628.9620.15645
	addi	t6, x0, 2
...
beq_cont.36349:
	...
	sw	a3,12(a1) 
	lw	a4, -16(sp) # Restore refltype.5629.9621.15647
	sw	a4,8(a1) 
	lw	a4, -20(sp) # Restore form.5628.9620.15645
	sw	a4,4(a1) 
	lw	a5, -12(sp) # Restore texture.5626.9618.15641
	sw	a5,0(a1) 
...
beq_cont.36390:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -72(sp) # Save flag00.6567.10559.30185
	fsw	fa1, -76(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	sw	ra, -84(sp)
...
beq_cont.36398:
	...
	lw	a0, -72(sp) # Restore flag00.6567.10559.30185
	jal	x0, bne_cont.36400
bne_else.36399:
	addi	a0, x0, 1
	lw	a1, -72(sp) # Restore flag00.6567.10559.30185
	sub	a0, a0, a1
bne_cont.36400:
	addi	t6, x0, 1
...
beq_cont.36464:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -152(sp) # Save flag00.6567.10559.29966
	fsw	fa1, -156(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	sw	ra, -164(sp)
...
beq_cont.36472:
	...
	lw	a0, -152(sp) # Restore flag00.6567.10559.29966
	jal	x0, bne_cont.36474
bne_else.36473:
	addi	a0, x0, 1
	lw	a1, -152(sp) # Restore flag00.6567.10559.29966
	sub	a0, a0, a1
bne_cont.36474:
	addi	t6, x0, 1
...
beq_cont.36538:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -232(sp) # Save flag00.6567.10559.29747
	fsw	fa1, -236(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	sw	ra, -244(sp)
...
beq_cont.36546:
	...
	lw	a0, -232(sp) # Restore flag00.6567.10559.29747
	jal	x0, bne_cont.36548
bne_else.36547:
	addi	a0, x0, 1
	lw	a1, -232(sp) # Restore flag00.6567.10559.29747
	sub	a0, a0, a1
bne_cont.36548:
	addi	t6, x0, 1
...
be_else.36605:
	addi	a2, a0, 1
	sw	a1, -0(sp) # Save item.5606.9598
	sw	a0, -4(sp) # Save length.2999.6991
	addi	a0, a2, 0
	sw	ra, -12(sp)
	addi	sp, sp, -16
	...
	addi	sp, sp, 16
	lw	ra, -12(sp)
	lw	a1, -4(sp) # Restore length.2999.6991
	slli	a1, a1, 2
	add	a1, a0, a1
	lw	a2, -0(sp) # Restore item.5606.9598
	sw	a2,0(a1) 
	jalr	x0, ra, 0
...
iter_setup_dirvec_constants.3099.7091: # 11068
	...
	addil	a5, a5, l.30831
	flw	fa0, 0(a5)
	sw	a3, -4(sp) # Save m_const.6000.9992.14188
	sw	a1, -8(sp) # Save index.3101.7093
	sw	a2, -12(sp) # Save m.4973.8965
	sw	a4, -16(sp) # Save m_vec.6001.9993.14185
	fsw	fa0, 0(hp)
	fsw	fa0, 4(hp)
	fsw	fa0, 8(hp)
	fsw	fa0, 12(hp)
	...
	addi	a0, hp, 0
	addi	hp, hp, 24
	lw	a1, -16(sp) # Restore m_vec.6001.9993.14185
	addi	a2, a1 0
	flw	fa0, 0(a2)
	fsgnjn	fs11, fa0, fa0
	feq	a2, fs11, fa0
	bne	a2, x0, beq_else.36615 # size : 208
	lw	a2, -12(sp) # Restore m.4973.8965
	lw	a3, 24(a2)
	addi	a4, a1 0
	flw	fa0, 0(a4)
	fsgnjn	fs11, fa0, fa0
...
beq_cont.36632:
	...
	slli	a2, a1, 2
	lw	a3, -4(sp) # Restore m_const.6000.9992.14188
	add	a2, a3, a2
	sw	a0,0(a2) 
...
be_else.36855:
	...
	flw	fa1, 0(a5)
	flt	a5, fa1, fa0
	sw	a2, -0(sp) # Save dirvec.3147.7139
	sw	a1, -4(sp) # Save and_group.3146.7138
	sw	a0, -8(sp) # Save iand_ofs.3145.7137
...
beq_else.36860:
	...
	fadd	fa3, fa3, fa4
	addi	a5, x0, 0
	sw	a4, -12(sp) # Save t0.4716.8708
	sw	a3, -16(sp) # Save iobj.4714.8706
	fsw	fa3, -20(sp)
	fsw	fa2, -24(sp)
	fsw	fa1, -28(sp)
	fsw	fa0, -32(sp)
...
beq_else.36862:
	...
	fsw	fa0, 0(a0) 
	addi	a0, x0, 820
	lw	a1, -16(sp) # Restore iobj.4714.8706
	sw	a1,0(a0) 
	addi	a0, x0, 800
	lw	a1, -12(sp) # Restore t0.4716.8708
	sw	a1,0(a0) 
beq_cont.36863:
beq_cont.36861:
beq_cont.36859:
	lw	a0, -8(sp) # Restore iand_ofs.3145.7137
	addi	a0, a0, 1
	lw	a1, -4(sp) # Restore and_group.3146.7138
	lw	a2, -0(sp) # Restore dirvec.3147.7139
	jal	x0, solve_each_element.3144.7136 
...
be_else.36864:
	...
	lw	a3, 0(a3)
	addi	a4, x0, 0
	sw	a2, -0(sp) # Save dirvec.3151.7143
	sw	a1, -4(sp) # Save or_group.3150.7142
	sw	a0, -8(sp) # Save ofs.3149.7141
	addi	a1, a3, 0
	addi	a0, a4, 0
	sw	ra, -16(sp)
	addi	sp, sp, -20
	...
	addi	sp, sp, 20
	lw	ra, -16(sp)
	lw	a0, -8(sp) # Restore ofs.3149.7141
	addi	a0, a0, 1
	lw	a1, -4(sp) # Restore or_group.3150.7142
	lw	a2, -0(sp) # Restore dirvec.3151.7143
...
trace_or_matrix.3152.7144: # 18704
	...
	jalr	x0, ra, 0
be_else.36866:
	sw	a2, -0(sp) # Save dirvec.3155.7147
	sw	a1, -4(sp) # Save or_network.3154.7146
	sw	a0, -8(sp) # Save ofs.3153.7145
	addi	t6, x0, 99
...
beq_cont.36933:
beq_cont.36869:
	lw	a0, -8(sp) # Restore ofs.3153.7145
	addi	a0, a0, 1
	lw	a1, -4(sp) # Restore or_network.3154.7146
	lw	a2, -0(sp) # Restore dirvec.3155.7147
...
be_else.36974:
	...
	flw	fa1, 0(a6)
	flt	a6, fa1, fa0
	sw	a2, -0(sp) # Save dirvec.3161.7153
	sw	a1, -4(sp) # Save and_group.3160.7152
	sw	a0, -8(sp) # Save iand_ofs.3159.7151
...
beq_else.36979:
	...
	fadd	fa3, fa3, fa4
	addi	a3, x0, 0
	sw	a5, -12(sp) # Save t0.4608.8600
	sw	a4, -16(sp) # Save iobj.4606.8598
	fsw	fa3, -20(sp)
	fsw	fa2, -24(sp)
	fsw	fa1, -28(sp)
	fsw	fa0, -32(sp)
...
beq_else.36981:
	...
	fsw	fa0, 0(a0) 
	addi	a0, x0, 820
	lw	a1, -16(sp) # Restore iobj.4606.8598
	sw	a1,0(a0) 
	addi	a0, x0, 800
	lw	a1, -12(sp) # Restore t0.4608.8600
	sw	a1,0(a0) 
beq_cont.36982:
beq_cont.36980:
beq_cont.36978:
	lw	a0, -8(sp) # Restore iand_ofs.3159.7151
	addi	a0, a0, 1
	lw	a1, -4(sp) # Restore and_group.3160.7152
	lw	a2, -0(sp) # Restore dirvec.3161.7153
	jal	x0, solve_each_element_fast.3158.7150 
...
be_else.36983:
	...
	lw	a3, 0(a3)
	addi	a4, x0, 0
	sw	a2, -0(sp) # Save dirvec.3165.7157
	sw	a1, -4(sp) # Save or_group.3164.7156
	sw	a0, -8(sp) # Save ofs.3163.7155
	addi	a1, a3, 0
	addi	a0, a4, 0
	sw	ra, -16(sp)
	addi	sp, sp, -20
	...
	addi	sp, sp, 20
	lw	ra, -16(sp)
	lw	a0, -8(sp) # Restore ofs.3163.7155
	addi	a0, a0, 1
	lw	a1, -4(sp) # Restore or_group.3164.7156
	lw	a2, -0(sp) # Restore dirvec.3165.7157
...
trace_or_matrix_fast.3166.7158: # 21840
	...
	jalr	x0, ra, 0
be_else.36985:
	sw	a2, -0(sp) # Save dirvec.3169.7161
	sw	a1, -4(sp) # Save or_network.3168.7160
	sw	a0, -8(sp) # Save ofs.3167.7159
	addi	t6, x0, 99
...
beq_cont.37026:
beq_cont.36988:
	lw	a0, -8(sp) # Restore ofs.3167.7159
	addi	a0, a0, 1
	lw	a1, -4(sp) # Restore or_network.3168.7160
	lw	a2, -0(sp) # Restore dirvec.3169.7161
...
trace_reflections.3188.7180: # 22868
	...
	fsw	fa1, -4(sp)
	sw	a1, -8(sp) # Save dirvec.3192.7184
	fsw	fa0, -12(sp)
	sw	a3, -16(sp) # Save m_dvec.5994.9986.12950
	sw	a2, -20(sp) # Save rinfo.4240.8232
	addi	a2, a3, 0
	addi	a1, a5, 0
	addi	a0, a4, 0
	sw	ra, -28(sp)
...
beq_else.37032:
	...
	lw	a1, 0(a1)
	add	a0, a0, a1
	lw	a1, -20(sp) # Restore rinfo.4240.8232
	lw	a2, 0(a1)
	...
	addi	a0, x0, 824
	lw	a1, -16(sp) # Restore m_dvec.5994.9986.12950
	lw	a2, 0(a1)
	addi	a3, a0 0
	flw	fa0, 0(a3)
	addi	a3, a2 0
	...
	fmul	fa1, fa1, fa2
	fadd	fa0, fa0, fa1
	lw	a0, -20(sp) # Restore rinfo.4240.8232
	flw	fa1, 8(a0)
	flw	fa2, -12(sp)
	fmul	fa3, fa1, fa2
	fmul	fa0, fa3, fa0
	lw	a0, 0(a1)
	lw	a1, -8(sp) # Restore dirvec.3192.7184
	addi	a2, a1 0
	flw	fa3, 0(a2)
	addi	a2, a0 0
	flw	fa4, 0(a2)
...
bg_sub.37044:
	...
	addi	a5, x0, 792
	lw	a5, 0(a5)
	sw	t5, -0(sp) # Save trace_ray.3193.7185
	fsw	fa1, -4(sp)
	sw	a2, -8(sp) # Save pixel.3197.7189
	fsw	fa2, -12(sp)
	fsw	fa0, -16(sp)
	sw	a1, -20(sp) # Save dirvec.3196.7188
	sw	a3, -24(sp) # Save m_sids.6055.10047.12855
	sw	a0, -28(sp) # Save nref.3194.7186
	addi	a2, a1, 0
	addi	a0, a4, 0
	addi	a1, a5, 0
	sw	ra, -36(sp)
...
beq_cont.37047:
	...
	addi	a0, x0, -1
	lw	a1, -28(sp) # Restore nref.3194.7186
	slli	a2, a1, 2
	lw	a3, -24(sp) # Restore m_sids.6055.10047.12855
	add	a2, a3, a2
	sw	a0,0(a2) 
...
be_else.37049:
	addi	a0, x0, 568
	lw	a1, -20(sp) # Restore dirvec.3196.7188
	addi	a2, a1 0
	flw	fa0, 0(a2)
	addi	a2, a0 0
	flw	fa1, 0(a2)
...
be_else.37048:
	...
	addi	a3, a3, -1
	slli	a3, a3, 2
	lw	a5, -20(sp) # Restore dirvec.3196.7188
	add	a3, a5, a3
	flw	fa2, 0(a3)
	fsgnjn	fs11, fa2, fa2
	feq	a3, fs11, fa2
...
beq_cont.37055:
	...
	addi	a5, a5, 8
	fsw	fa2, 0(a5) 
	sw	a2, -32(sp) # Save m_surface.6291.10283.12812
	fsw	fa0, -36(sp)
	sw	a1, -40(sp) # Save obj.4106.8098
	sw	a0, -44(sp) # Save obj_id.4105.8097
	addi	t6, x0, 1
...
beq_cont.37125:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -92(sp) # Save flag00.6567.10559.16120.19017
	fsw	fa1, -96(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	sw	ra, -104(sp)
...
beq_cont.37133:
	...
	lw	a0, -92(sp) # Restore flag00.6567.10559.16120.19017
	jal	x0, bne_cont.37135
bne_else.37134:
	addi	a0, x0, 1
	lw	a1, -92(sp) # Restore flag00.6567.10559.16120.19017
	sub	a0, a0, a1
bne_cont.37135:
	addi	t6, x0, 1
...
beq_cont.37077:
beq_cont.37069:
	lw	a0, -44(sp) # Restore obj_id.4105.8097
	slli	a0, a0, 2
	addi	a1, x0, 800
	lw	a1, 0(a1)
	add	a0, a0, a1
	...
	add	a2, a3, a2
	sw	a0,0(a2) 
	lw	a0, -8(sp) # Restore pixel.3197.7189
	lw	a2, 4(a0)
	slli	a4, a1, 2
	add	a2, a2, a4
	lw	a2, 0(a2)
	...
	fsw	fa0, 0(a2) 
	lw	a2, 12(a0)
	lw	a4, -40(sp) # Restore obj.4106.8098
	lw	a5, 28(a4)
	flw	fa0, 0(a5)
	luil	a5, l.30948
	srli	a5, a5, 1
...
beq_cont.37202:
	...
	jalr	x0, ra, 0
be_else.37207:
	lw	a0, -28(sp) # Restore nref.3194.7186
	addi	t6, x0, 4
...
bg_else.37209:
	...
	sw	a2,0(a1) 
bg_cont.37210:
	lw	a1, -32(sp) # Restore m_surface.6291.10283.12812
	addi	t6, x0, 2
	...
	addil	a1, a1, l.30890
	flw	fa0, 0(a1)
	lw	a1, -40(sp) # Restore obj.4106.8098
	lw	a1, 28(a1)
	flw	fa2, 0(a1)
	fsub	fa0, fa0, fa2
	fmul	fa0, fa1, fa0
	...
	fadd	fa1, fa2, fa1
	lw	a1, -20(sp) # Restore dirvec.3196.7188
	lw	a2, -8(sp) # Restore pixel.3197.7189
	lw	t5, -0(sp) # Restore trace_ray.3193.7185
	lw	t6, 0(t5) 
	jalr	x0, t6, 0 
be_else.37211:
	jalr	x0, ra, 0
...
bg_sub.37214:
	...
	fsgnjn	fs11, fa1, fa1
	flt	a4, fa1, fs11
	sw	a2, -0(sp) # Save org.3205.7197
	sw	a1, -4(sp) # Save nvector.3204.7196
	sw	a0, -8(sp) # Save dirvec_group.3203.7195
	sw	t5, -12(sp) # Save iter_trace_diffuse_rays.3202.7194
	sw	a3, -16(sp) # Save index.3206.7198
...
beq_else.37216:
	...
	fsw	fa1, -20(sp)
	fsw	fa0, -24(sp)
	sw	a4, -28(sp) # Save Tt2216.4062.8054
	addi	a2, a4, 0
	addi	a1, a6, 0
	addi	a0, a5, 0
	sw	ra, -36(sp)
...
beq_else.37221:
	...
	addi	a0, a0, 304
	lw	a0, 0(a0)
	lw	a1, -28(sp) # Restore Tt2216.4062.8054
	lw	a1, 0(a1)
	lw	a2, 4(a0)
	addi	t6, x0, 1
...
beq_cont.37294:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -80(sp) # Save flag00.6567.10559.26990
	fsw	fa1, -84(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	sw	ra, -92(sp)
...
beq_cont.37302:
	...
	lw	a0, -80(sp) # Restore flag00.6567.10559.26990
	jal	x0, bne_cont.37304
bne_else.37303:
	addi	a0, x0, 1
	lw	a1, -80(sp) # Restore flag00.6567.10559.26990
	sub	a0, a0, a1
bne_cont.37304:
	addi	t6, x0, 1
...
beq_sub.37218:
	...
	fsw	fa1, -108(sp)
	fsw	fa0, -24(sp)
	sw	a4, -112(sp) # Save Tt2211.4067.8059
	addi	a2, a4, 0
	addi	a1, a6, 0
	addi	a0, a5, 0
	sw	ra, -120(sp)
...
beq_else.37374:
	...
	addi	a0, a0, 304
	lw	a0, 0(a0)
	lw	a1, -112(sp) # Restore Tt2211.4067.8059
	lw	a1, 0(a1)
	lw	a2, 4(a0)
	addi	t6, x0, 1
...
beq_cont.37447:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -164(sp) # Save flag00.6567.10559.27786
	fsw	fa1, -168(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	sw	ra, -176(sp)
...
beq_cont.37455:
	...
	lw	a0, -164(sp) # Restore flag00.6567.10559.27786
	jal	x0, bne_cont.37457
bne_else.37456:
	addi	a0, x0, 1
	lw	a1, -164(sp) # Restore flag00.6567.10559.27786
	sub	a0, a0, a1
bne_cont.37457:
	addi	t6, x0, 1
...
beq_cont.37375:
beq_cont.37217:
	lw	a0, -16(sp) # Restore index.3206.7198
	addi	a3, a0, -2
	lw	a0, -8(sp) # Restore dirvec_group.3203.7195
	lw	a1, -4(sp) # Restore nvector.3204.7196
	lw	a2, -0(sp) # Restore org.3205.7197
	lw	t5, -12(sp) # Restore iter_trace_diffuse_rays.3202.7194
	lw	t6, 0(t5) 
	jalr	x0, t6, 0 
...
beq_else.37527:
	...
	add	a5, a5, a7
	lw	a5, 0(a5)
	sw	a6, -8(sp) # Save m_engy.6041.10033.17697
	sw	a1, -12(sp) # Save nref.3226.7218
	sw	a4, -16(sp) # Save Ta2245.4025.8017.11775
	sw	a2, -20(sp) # Save iter_trace_diffuse_rays.3202.7194
	sw	a5, -24(sp) # Save Ta2246.4026.8018.11776
	sw	a3, -28(sp) # Save Ti2244.4024.8016.11774
...
beq_else.37529:
	...
	lw	a1, -16(sp) # Restore Ta2245.4025.8017.11775
	lw	a2, -24(sp) # Restore Ta2246.4026.8018.11776
	lw	t5, -20(sp) # Restore iter_trace_diffuse_rays.3202.7194
	lw	t6, 0(t5)
	sw	ra, -40(sp)
	addi	sp, sp, -44
	...
	lw	ra, -40(sp)
beq_cont.37530:
	lw	a0, -28(sp) # Restore Ti2244.4024.8016.11774
	addi	t6, x0, 1
...
beq_else.37531:
	...
	lw	a1, 0(a1)
	addi	a2, x0, 904
	lw	a3, -24(sp) # Restore Ta2246.4026.8018.11776
	addi	a4, a3 0
	flw	fa0, 0(a4)
	addi	a4, a2 0
	fsw	fa0, 0(a4) 
...
beq_cont.37538:
	addi	a0, x0, 860
	lw	a1, -12(sp) # Restore nref.3226.7218
	slli	a2, a1, 2
	lw	a3, -8(sp) # Restore m_engy.6041.10033.17697
	add	a2, a3, a2
	lw	a2, 0(a2)
	addi	a3, x0, 848
	addi	a4, a0 0
...
pretrace_diffuse_rays.3255.7247: # 52328
	...
	add	a3, a3, a4
	lw	a3, 0(a3)
	sw	t5, -0(sp) # Save pretrace_diffuse_rays.3255.7247
	sw	a1, -4(sp) # Save nref.3257.7249
...
beq_else.37558:
	...
	lw	a1, 20(a0)
	lw	a2, -4(sp) # Restore nref.3257.7249
	slli	a3, a2, 2
	add	a1, a1, a3
	lw	a1, 0(a1)
	addi	a3, x0, 848
	...
	fsw	fa0, 8(a1) 
beq_cont.37559:
	lw	a1, -4(sp) # Restore nref.3257.7249
	addi	a1, a1, 1
	lw	t5, -0(sp) # Restore pretrace_diffuse_rays.3255.7247
	lw	t6, 0(t5) 
	jalr	x0, t6, 0 
bg_else.37557:
	jalr	x0, ra, 0
...
beq_cont.37564:
	...
	fsw	fa1, -4(sp)
	fsw	fa0, -8(sp)
	sw	t5, -12(sp) # Save pretrace_pixels.3258.7250
	sw	a4, -16(sp) # Save pretrace_diffuse_rays.3255.7247
	sw	a2, -20(sp) # Save group_id.3261.7253
	sw	a0, -24(sp) # Save line.3259.7251
	sw	a1, -28(sp) # Save x.3260.7252
	addi	a2, a7, 0
	addi	a1, a6, 0
	addi	a0, a5, 0
	addi	t5, a3, 0
	...
	addi	sp, sp, 40
	lw	ra, -36(sp)
	lw	a0, -28(sp) # Restore x.3260.7252
	slli	a1, a0, 2
	lw	a2, -24(sp) # Restore line.3259.7251
	add	a1, a2, a1
	lw	a1, 0(a1)
	lw	a1, 0(a1)
	addi	a3, x0, 860
	...
	lw	a1, 0(a1)
	lw	a1, 24(a1)
	lw	a3, -20(sp) # Restore group_id.3261.7253
	sw	a3,0(a1) 
	slli	a1, a0, 2
	add	a1, a2, a1
	lw	a1, 0(a1)
	addi	a4, x0, 0
	lw	t5, -16(sp) # Restore pretrace_diffuse_rays.3255.7247
	addi	a0, a1, 0
	addi	a1, a4, 0
	lw	t6, 0(t5)
	sw	ra, -36(sp)
	...
	lw	a0, -28(sp) # Restore x.3260.7252
	addi	a1, a0, -1
	lw	a0, -20(sp) # Restore group_id.3261.7253
	addi	a0, a0, 1
	addi	t6, x0, 5
...
bg_cont.37566:
	...
	flw	fa1, -4(sp)
	flw	fa2, -0(sp)
	lw	a0, -24(sp) # Restore line.3259.7251
	lw	t5, -12(sp) # Restore pretrace_pixels.3258.7250
	lw	t6, 0(t5) 
	jalr	x0, t6, 0 
bg_else.37562:
	jalr	x0, ra, 0
...
bg_cont.37573:
bg_cont.37571:
	sw	a4, -0(sp) # Save next.3274.7266
	sw	a3, -4(sp) # Save cur.3273.7265
	sw	a2, -8(sp) # Save prev.3272.7264
	sw	a1, -12(sp) # Save y.3271.7263
	sw	t5, -16(sp) # Save scan_pixel.3269.7261
	sw	a0, -20(sp) # Save x.3270.7262
	sw	a5, -24(sp) # Save version.3275.7267
...
beq_else.37578:
	...
	lw	ra, -32(sp)
beq_cont.37579:
	lw	a5, -24(sp) # Restore version.3275.7267
	addi	t6, x0, 3
...
bg_cont.37603:
	sw	a0, 0(s11)
beq_cont.37581:
	lw	a0, -20(sp) # Restore x.3270.7262
	addi	a0, a0, 1
	lw	a1, -12(sp) # Restore y.3271.7263
	lw	a2, -8(sp) # Restore prev.3272.7264
	lw	a3, -4(sp) # Restore cur.3273.7265
	lw	a4, -0(sp) # Restore next.3274.7266
	lw	t5, -16(sp) # Restore scan_pixel.3269.7261
	lw	t6, 0(t5) 
	jalr	x0, t6, 0 
...
beq_cont.37664:
	...
	flw	fa6, 0(a3)
	fsw	fa2, -0(sp)
	sw	a2, -4(sp) # Save index.3304.7296
	sw	a1, -8(sp) # Save group_id.3303.7295
	sw	t5, -12(sp) # Save calc_dirvec.3297.7289
	fsw	fa3, -16(sp)
	sw	a0, -20(sp) # Save icount.3298.7290
	fsw	fa0, -24(sp)
	fsw	fa1, -28(sp)
	fsw	fa4, -32(sp)
	fsw	fa5, -36(sp)
...
beq_cont.37706:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -76(sp) # Save flag00.6567.10559.26211
	fsw	fa1, -80(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	sw	ra, -88(sp)
...
beq_cont.37714:
	...
	lw	a0, -76(sp) # Restore flag00.6567.10559.26211
	jal	x0, bne_cont.37716
bne_else.37715:
	addi	a0, x0, 1
	lw	a1, -76(sp) # Restore flag00.6567.10559.26211
	sub	a0, a0, a1
bne_cont.37716:
	addi	t6, x0, 1
...
beq_cont.37718:
	...
	flw	fa2, -24(sp)
	fmul	fa0, fa0, fa2
	lw	a0, -20(sp) # Restore icount.3298.7290
	addi	a0, a0, 1
	fmul	fa2, fa0, fa0
	luil	a1, l.32875
	srli	a1, a1, 1
...
beq_cont.37756:
	...
	flw	fa6, 0(a1)
	fsw	fa0, -104(sp)
	sw	a0, -108(sp) # Save Ti2573.3594.7586
	fsw	fa2, -112(sp)
	fsw	fa3, -116(sp)
	fsw	fa5, -120(sp)
	fsgnj	fa1, fa6, fa6
...
beq_cont.37798:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -160(sp) # Save flag00.6567.10559.25852
	fsw	fa1, -164(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	sw	ra, -172(sp)
...
beq_cont.37806:
	...
	lw	a0, -160(sp) # Restore flag00.6567.10559.25852
	jal	x0, bne_cont.37808
bne_else.37807:
	addi	a0, x0, 1
	lw	a1, -160(sp) # Restore flag00.6567.10559.25852
	sub	a0, a0, a1
bne_cont.37808:
	addi	t6, x0, 1
...
beq_cont.37810:
	...
	flw	fa2, -0(sp)
	flw	fa3, -16(sp)
	lw	a0, -108(sp) # Restore Ti2573.3594.7586
	lw	a1, -8(sp) # Restore group_id.3303.7295
	lw	a2, -4(sp) # Restore index.3304.7296
	lw	t5, -12(sp) # Restore calc_dirvec.3297.7289
	lw	t6, 0(t5) 
	jalr	x0, t6, 0 
calc_dirvecs.3305.7297: # 65072
	...
	addil	a5, a5, l.30831
	flw	fa3, 0(a5)
	sw	t5, -0(sp) # Save calc_dirvecs.3305.7297
	fsw	fa0, -4(sp)
	sw	a1, -8(sp) # Save group_id.3308.7300
	sw	a3, -12(sp) # Save calc_dirvec.3297.7289
	sw	a2, -16(sp) # Save index.3309.7301
	sw	a0, -20(sp) # Save col.3306.7298
	addi	a0, a4, 0
	addi	t5, a3, 0
	fsgnj	fs11, fa3, fa3
	fsgnj	fa3, fa0, fa0
	...
	addi	sp, sp, 32
	lw	ra, -28(sp)
	lw	a0, -20(sp) # Restore col.3306.7298
	fcvtsw	fa0, a0
	luil	a1, l.32447
	srli	a1, a1, 1
	addil	a1, a1, l.32447
	...
	addil	a2, a2, l.30831
	flw	fa1, 0(a2)
	lw	a2, -16(sp) # Restore index.3309.7301
	addi	a3, a2, 2
	flw	fa3, -4(sp)
	lw	a4, -8(sp) # Restore group_id.3308.7300
	lw	t5, -12(sp) # Restore calc_dirvec.3297.7289
	addi	a2, a3, 0
	addi	a0, a1, 0
	addi	a1, a4, 0
	...
	lw	a0, -20(sp) # Restore col.3306.7298
	addi	a0, a0, -1
	lw	a1, -8(sp) # Restore group_id.3308.7300
	addi	a1, a1, 1
	addi	t6, x0, 5
...
bg_cont.37829:
	flw	fa0, -4(sp)
	lw	a2, -16(sp) # Restore index.3309.7301
	lw	t5, -0(sp) # Restore calc_dirvecs.3305.7297
	lw	t6, 0(t5) 
	jalr	x0, t6, 0 
bg_else.37827:
	jalr	x0, ra, 0
calc_dirvec_rows.3310.7302: # 65428
	...
	fsub	fa0, fa0, fa1
	addi	a4, x0, 4
	sw	t5, -0(sp) # Save calc_dirvec_rows.3310.7302
	sw	a2, -4(sp) # Save index.3313.7305
	sw	a1, -8(sp) # Save group_id.3312.7304
	sw	a0, -12(sp) # Save row.3311.7303
	addi	a0, a4, 0
	addi	t5, a3, 0
	lw	t6, 0(t5)
	sw	ra, -20(sp)
	...
	addi	sp, sp, 24
	lw	ra, -20(sp)
	lw	a0, -12(sp) # Restore row.3311.7303
	addi	a0, a0, -1
	lw	a1, -8(sp) # Restore group_id.3312.7304
	addi	a1, a1, 2
	addi	t6, x0, 5
...
bg_else.37832:
bg_cont.37833:
	lw	a2, -4(sp) # Restore index.3313.7305
	addi	a2, a2, 4
	lw	t5, -0(sp) # Restore calc_dirvec_rows.3310.7302
	lw	t6, 0(t5) 
	jalr	x0, t6, 0 
bg_else.37831:
	jalr	x0, ra, 0
...
init_dirvec_constants.3321.7313: # 66404
	...
	lw	a3, 0(a3)
	addi	a3, a3, -1
	sw	a0, -0(sp) # Save vecset.3322.7314
	sw	a1, -4(sp) # Save index.3323.7315
	addi	a1, a3, 0
	addi	a0, a2, 0
	sw	ra, -12(sp)
	addi	sp, sp, -16
	...
	addi	sp, sp, 16
	lw	ra, -12(sp)
	lw	a0, -4(sp) # Restore index.3323.7315
	addi	a1, a0, -1
	lw	a0, -0(sp) # Restore vecset.3322.7314
...
min_caml_start:
	...
	addil	a5, a5, l.30831
	flw	fa1, 0(a5)
	sw	a6, -12(sp) # Save Ti2769.3350.7342
	sw	a3, -16(sp) # Save scan_line.3276.7268
	sw	a2, -20(sp) # Save pretrace_pixels.3258.7250
	sw	a1, -24(sp) # Save calc_dirvec_rows.3310.7302
	sw	a0, -28(sp) # Save read_object.2994.6986
	fsw	fa0, -32(sp)
...
beq_cont.37976:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -152(sp) # Save next.3358.7350.10781
	fsw	fa0, -156(sp)
	fsw	fa1, -160(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
...
beq_cont.37984:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -172(sp) # Save flag00.6567.10559.16120.25359
	fsw	fa1, -176(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	sw	ra, -184(sp)
...
beq_cont.37992:
	...
	lw	a0, -172(sp) # Restore flag00.6567.10559.16120.25359
	jal	x0, bne_cont.37994
bne_else.37993:
	addi	a0, x0, 1
	lw	a1, -172(sp) # Restore flag00.6567.10559.16120.25359
	sub	a0, a0, a1
bne_cont.37994:
	addi	t6, x0, 1
...
beq_cont.38058:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -248(sp) # Save flag00.6567.10559.16120.25152
	fsw	fa1, -252(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	sw	ra, -260(sp)
...
beq_cont.38066:
	...
	lw	a0, -248(sp) # Restore flag00.6567.10559.16120.25152
	jal	x0, bne_cont.38068
bne_else.38067:
	addi	a0, x0, 1
	lw	a1, -248(sp) # Restore flag00.6567.10559.16120.25152
	sub	a0, a0, a1
bne_cont.38068:
	addi	t6, x0, 1
...
beq_cont.38168:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -348(sp) # Save flag00.6567.10559.16120.24846
	fsw	fa1, -352(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	sw	ra, -360(sp)
...
beq_cont.38176:
	...
	lw	a0, -348(sp) # Restore flag00.6567.10559.16120.24846
	jal	x0, bne_cont.38178
bne_else.38177:
	addi	a0, x0, 1
	lw	a1, -348(sp) # Restore flag00.6567.10559.16120.24846
	sub	a0, a0, a1
bne_cont.38178:
	addi	t6, x0, 1
...
beq_cont.38242:
	...
	addil	a1, a1, l.30827
	flw	fa2, 0(a1)
	sw	a0, -416(sp) # Save flag00.6567.10559.16120.24640
	fsw	fa1, -420(sp)
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	sw	ra, -428(sp)
...
beq_cont.38250:
	...
	lw	a0, -416(sp) # Restore flag00.6567.10559.16120.24640
	jal	x0, bne_cont.38252
bne_else.38251:
	addi	a0, x0, 1
	lw	a1, -416(sp) # Restore flag00.6567.10559.16120.24640
	sub	a0, a0, a1
bne_cont.38252:
	addi	t6, x0, 1
...
beq_cont.38254:
	...
	fsw	fa0, 0(a0) 
	addi	a0, x0, 0
	lw	t5, -28(sp) # Restore read_object.2994.6986
	lw	t6, 0(t5)
	sw	ra, -448(sp)
	addi	sp, sp, -452
	jalr	ra, t6, 0 # CallCls t5
	...
	addi	a1, x0, 0
	addi	a2, x0, 0
	lw	t5, -24(sp) # Restore calc_dirvec_rows.3310.7302
	lw	t6, 0(t5)
	sw	ra, -452(sp)
	addi	sp, sp, -456
	jalr	ra, t6, 0 # CallCls t5
...
beq_else.38275:
	...
	flw	fa5, 0(a3)
	fsw	fa1, -448(sp)
	sw	a0, -452(sp) # Save sid.3455.7447.10989.16381
	sw	a2, -456(sp) # Save nr.3456.7448.10992.16384
	sw	a1, -460(sp) # Save Ti2663.3482.7474.11009.16401
	fsw	fa0, -464(sp)
	fsw	fa3, -468(sp)
	fsw	fa2, -472(sp)
	fsw	fa4, -476(sp)
...
create_array_end.38280:
	...
	sw	a1,4(a0) 
	lw	a1, -460(sp) # Restore Ti2663.3482.7474.11009.16401
	sw	a1,0(a0) 
	lw	a1, -456(sp) # Restore nr.3456.7448.10992.16384
	slli	a2, a1, 2
	addi	a2, a2, 1264
	sw	a0,0(a2) 
	addi	a0, a1, 1
	lw	a2, -452(sp) # Restore sid.3455.7447.10989.16381
	addi	a3, a2, 2
	addi	a4, x0, 568
	addi	a4, a4, 4
	flw	fa1, 0(a4)
	...
	addil	a4, a4, l.30831
	flw	fa2, 0(a4)
	sw	a0, -488(sp) # Save Ti2668.3475.7467.11015.16407
...
create_array_end.38282:
	...
	sw	a1,0(a0) 
	lw	a1, -488(sp) # Restore Ti2668.3475.7467.11015.16407
	slli	a1, a1, 2
	addi	a1, a1, 1264
	sw	a0,0(a1) 
	lw	a0, -456(sp) # Restore nr.3456.7448.10992.16384
	addi	a1, a0, 2
	lw	a2, -452(sp) # Restore sid.3455.7447.10989.16381
	addi	a2, a2, 3
	addi	a3, x0, 568
	...
	addil	a3, a3, l.30831
	flw	fa2, 0(a3)
	sw	a1, -508(sp) # Save Ti2675.3468.7460.11023.16415
...
create_array_end.38284:
	...
	sw	a1,0(a0) 
	lw	a1, -508(sp) # Restore Ti2675.3468.7460.11023.16415
	slli	a1, a1, 2
	addi	a1, a1, 1264
	sw	a0,0(a1) 
	addi	a0, x0, 1984
...
beq_else.38277:
	...
	addil	a1, a1, l.30831
	flw	fa4, 0(a1)
	sw	a2, -528(sp) # Save nr.3414.7406.10952.16344
	sw	a0, -532(sp) # Save sid.3413.7405.10949.16341
	fsw	fa0, -536(sp)
	fsw	fa1, -540(sp)
	fsw	fa3, -544(sp)
	fsw	fa2, -548(sp)
...
create_array_end.38288:
	...
	sw	a1,4(a0) 
	lw	a1, -532(sp) # Restore sid.3413.7405.10949.16341
	sw	a1,0(a0) 
	lw	a1, -528(sp) # Restore nr.3414.7406.10952.16344
	slli	a2, a1, 2
	addi	a2, a2, 1264
	sw	a0,0(a2) 
	addi	a0, x0, 1984
...
bg_cont.38272:
	...
	lw	a3, -152(sp) # Restore next.3358.7350.10781
	lw	a5, -12(sp) # Restore Ti2769.3350.7342
