...
beq_else.36827:
	...
	addil	a5, a5, l.31154
	flw	fa0, 0(a5)
	sw	a2, -4(sp) # Save form.5627.9627.15661
	sw	a3, -8(sp) # Save refltype.5628.9628.15663
	sw	a1, -12(sp) # Save texture.5625.9625.15657
...
beq_else.36834:
	...
	fsw	fa0, 0(a2) 
beq_cont.36835:
	lw	a2, -4(sp) # Restore form.5627.9627.15661
	addi	t6, x0, 2
...
beq_cont.36837:
	...
	sw	a4,8(a1) 
	lw	a4, -4(sp) # Restore form.5627.9627.15661
	sw	a4,4(a1) 
	lw	a5, -12(sp) # Restore texture.5625.9625.15657
	sw	a5,0(a1) 
...
beq_cont.36878:
	...
	flw	fa4, 0(a1)
	fsw	fa3, -68(sp)
	sw	a0, -72(sp) # Save flag00.6568.10568.30505
	fsw	fa0, -76(sp)
	fsw	fa1, -80(sp)
	fsgnj	fa1, fa4, fa4
	fsgnj	fa0, fa3, fa3
...
beq_cont.36886:
	...
	lw	a0, -72(sp) # Restore flag00.6568.10568.30505
	jal	x0, bne_cont.36888
bne_else.36887:
	addi	a0, x0, 1
	lw	a1, -72(sp) # Restore flag00.6568.10568.30505
	sub	a0, a0, a1
bne_cont.36888:
	addi	t6, x0, 1
...
beq_cont.36952:
	...
	flw	fa4, 0(a1)
	fsw	fa3, -188(sp)
	sw	a0, -192(sp) # Save flag00.6568.10568.30269
	fsw	fa0, -196(sp)
	fsw	fa1, -200(sp)
	fsgnj	fa1, fa4, fa4
	fsgnj	fa0, fa3, fa3
...
beq_cont.36960:
	...
	lw	a0, -192(sp) # Restore flag00.6568.10568.30269
	jal	x0, bne_cont.36962
bne_else.36961:
	addi	a0, x0, 1
	lw	a1, -192(sp) # Restore flag00.6568.10568.30269
	sub	a0, a0, a1
bne_cont.36962:
	addi	t6, x0, 1
...
beq_cont.37026:
	...
	flw	fa4, 0(a1)
	fsw	fa3, -308(sp)
	sw	a0, -312(sp) # Save flag00.6568.10568.30033
	fsw	fa0, -316(sp)
	fsw	fa1, -320(sp)
	fsgnj	fa1, fa4, fa4
	fsgnj	fa0, fa3, fa3
...
beq_cont.37034:
	...
	lw	a0, -312(sp) # Restore flag00.6568.10568.30033
	jal	x0, bne_cont.37036
bne_else.37035:
	addi	a0, x0, 1
	lw	a1, -312(sp) # Restore flag00.6568.10568.30033
	sub	a0, a0, a1
bne_cont.37036:
	addi	t6, x0, 1
...
be_else.37093:
	addi	a2, a0, 1
	sw	a0, -0(sp) # Save length.2998.6998
	sw	a1, -4(sp) # Save item.5605.9605
	addi	a0, a2, 0
	sw	ra, -12(sp)
	addi	sp, sp, -16
	...
	addi	sp, sp, 16
	lw	ra, -12(sp)
	lw	a1, -0(sp) # Restore length.2998.6998
	slli	a1, a1, 2
	add	a1, a0, a1
	lw	a2, -4(sp) # Restore item.5605.9605
	sw	a2,0(a1) 
	jalr	x0, ra, 0
read_or_network.2999.6999: # 11796
	addi	a1, x0, 0
...
be_else.37095:
	...
	sw	a2,0(a1) 
	jalr	x0, ra, 0
read_and_network.3001.7001: # 11944
	addi	a1, x0, 0
...
iter_setup_dirvec_constants.3098.7098: # 12020
	...
	addil	a5, a5, l.31154
	flw	fa0, 0(a5)
	sw	a4, -4(sp) # Save m_vec.6000.10000.14201
	sw	a1, -8(sp) # Save index.3100.7100
	sw	a3, -12(sp) # Save m_const.5999.9999.14204
	sw	a2, -16(sp) # Save m.4972.8972
	fsw	fa0, 0(hp)
	fsw	fa0, 4(hp)
	fsw	fa0, 8(hp)
	fsw	fa0, 12(hp)
	...
	addi	a0, hp, 0
	addi	hp, hp, 24
	lw	a1, -4(sp) # Restore m_vec.6000.10000.14201
	addi	a2, a1, 0
	flw	fa0, 0(a2)
	fsgnjn	fs11, fa0, fa0
	feq	a2, fs11, fa0
	bne	a2, x0, beq_else.37103 # size : 208
	lw	a2, -16(sp) # Restore m.4972.8972
	lw	a3, 24(a2)
	addi	a4, a1, 0
	flw	fa0, 0(a4)
	fsgnjn	fs11, fa0, fa0
...
beq_cont.37120:
	...
	slli	a2, a1, 2
	lw	a3, -12(sp) # Restore m_const.5999.9999.14204
	add	a2, a3, a2
	sw	a0,0(a2) 
...
bg_else.37099:
	jalr	x0, ra, 0
setup_startp_constants.3103.7103: # 13656
...
bg_else.37140:
	jalr	x0, ra, 0
check_all_inside.3128.7128: # 14100
	slli	a2, a0, 2
	add	a2, a1, a2
	lw	a2, 0(a2)
	addi	t6, x0, -1
...
be_else.37179:
	addi	a0, x0, 0
	jalr	x0, ra, 0
shadow_check_and_group.3134.7134: # 14688
	slli	a2, a0, 2
	add	a2, a1, a2
	lw	a2, 0(a2)
	addi	t6, x0, -1
...
be_else.37225:
	addi	a0, x0, 1
	jalr	x0, ra, 0
shadow_check_one_or_group.3137.7137: # 16088
	slli	a2, a0, 2
	add	a2, a1, a2
	lw	a2, 0(a2)
	addi	t6, x0, -1
...
be_else.37227:
	addi	a0, x0, 1
	jalr	x0, ra, 0
shadow_check_one_or_matrix.3140.7140: # 16196
	slli	a2, a0, 2
	add	a2, a1, a2
	lw	a2, 0(a2)
	addi	a3, a2, 0
...
be_else.37278:
	addi	a0, x0, 1
	jalr	x0, ra, 0
solve_each_element.3143.7143: # 17540
	slli	a3, a0, 2
	add	a3, a1, a3
	lw	a3, 0(a3)
	addi	t6, x0, -1
...
be_else.37343:
	...
	flw	fa1, 0(a5)
	flt	a5, fa1, fa0
	sw	a0, -0(sp) # Save iand_ofs.3144.7144
	sw	a2, -4(sp) # Save dirvec.3146.7146
	sw	a1, -8(sp) # Save and_group.3145.7145
...
beq_else.37348:
	...
	fsw	fa2, -16(sp)
	fsw	fa3, -20(sp)
	sw	a4, -24(sp) # Save t0.4715.8715
	sw	a3, -28(sp) # Save iobj.4713.8713
	fsw	fa0, -32(sp)
	addi	a0, a5, 0
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
...
beq_else.37350:
	...
	fsw	fa0, 0(a0) 
	addi	a0, x0, 820
	lw	a1, -28(sp) # Restore iobj.4713.8713
	sw	a1,0(a0) 
	addi	a0, x0, 800
	lw	a1, -24(sp) # Restore t0.4715.8715
	sw	a1,0(a0) 
beq_cont.37351:
beq_cont.37349:
beq_cont.37347:
	lw	a0, -0(sp) # Restore iand_ofs.3144.7144
	addi	a0, a0, 1
	lw	a1, -8(sp) # Restore and_group.3145.7145
	lw	a2, -4(sp) # Restore dirvec.3146.7146
	jal	x0, solve_each_element.3143.7143 
solve_one_or_network.3147.7147: # 19556
	slli	a3, a0, 2
	add	a3, a1, a3
	lw	a3, 0(a3)
	addi	t6, x0, -1
...
be_else.37352:
	...
	lw	a3, 0(a3)
	addi	a4, x0, 0
	sw	a0, -0(sp) # Save ofs.3148.7148
	sw	a2, -4(sp) # Save dirvec.3150.7150
	sw	a1, -8(sp) # Save or_group.3149.7149
	addi	a1, a3, 0
	addi	a0, a4, 0
	sw	ra, -16(sp)
	addi	sp, sp, -20
	...
	addi	sp, sp, 20
	lw	ra, -16(sp)
	lw	a0, -0(sp) # Restore ofs.3148.7148
	addi	a0, a0, 1
	lw	a1, -8(sp) # Restore or_group.3149.7149
	lw	a2, -4(sp) # Restore dirvec.3150.7150
	jal	x0, solve_one_or_network.3147.7147 
trace_or_matrix.3151.7151: # 19656
	slli	a3, a0, 2
	add	a3, a1, a3
	lw	a3, 0(a3)
	addi	a4, a3, 0
	...
	jalr	x0, ra, 0
be_else.37354:
	sw	a0, -0(sp) # Save ofs.3152.7152
	sw	a2, -4(sp) # Save dirvec.3154.7154
	sw	a1, -8(sp) # Save or_network.3153.7153
	addi	t6, x0, 99
...
beq_cont.37421:
beq_cont.37357:
	lw	a0, -0(sp) # Restore ofs.3152.7152
	addi	a0, a0, 1
	lw	a1, -8(sp) # Restore or_network.3153.7153
	lw	a2, -4(sp) # Restore dirvec.3154.7154
	jal	x0, trace_or_matrix.3151.7151 
solve_each_element_fast.3157.7157: # 21452
	lw	a3, 0(a2)
	slli	a4, a0, 2
	add	a4, a1, a4
	lw	a4, 0(a4)
...
be_else.37462:
	...
	flw	fa1, 0(a6)
	flt	a6, fa1, fa0
	sw	a0, -0(sp) # Save iand_ofs.3158.7158
	sw	a2, -4(sp) # Save dirvec.3160.7160
	sw	a1, -8(sp) # Save and_group.3159.7159
...
beq_else.37467:
	...
	fsw	fa2, -16(sp)
	fsw	fa3, -20(sp)
	sw	a5, -24(sp) # Save t0.4607.8607
	sw	a4, -28(sp) # Save iobj.4605.8605
	fsw	fa0, -32(sp)
	addi	a0, a3, 0
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
...
beq_else.37469:
	...
	fsw	fa0, 0(a0) 
	addi	a0, x0, 820
	lw	a1, -28(sp) # Restore iobj.4605.8605
	sw	a1,0(a0) 
	addi	a0, x0, 800
	lw	a1, -24(sp) # Restore t0.4607.8607
	sw	a1,0(a0) 
beq_cont.37470:
beq_cont.37468:
beq_cont.37466:
	lw	a0, -0(sp) # Restore iand_ofs.3158.7158
	addi	a0, a0, 1
	lw	a1, -8(sp) # Restore and_group.3159.7159
	lw	a2, -4(sp) # Restore dirvec.3160.7160
	jal	x0, solve_each_element_fast.3157.7157 
solve_one_or_network_fast.3161.7161: # 22692
	slli	a3, a0, 2
	add	a3, a1, a3
	lw	a3, 0(a3)
	addi	t6, x0, -1
...
be_else.37471:
	...
	lw	a3, 0(a3)
	addi	a4, x0, 0
	sw	a0, -0(sp) # Save ofs.3162.7162
	sw	a2, -4(sp) # Save dirvec.3164.7164
	sw	a1, -8(sp) # Save or_group.3163.7163
	addi	a1, a3, 0
	addi	a0, a4, 0
	sw	ra, -16(sp)
	addi	sp, sp, -20
	...
	addi	sp, sp, 20
	lw	ra, -16(sp)
	lw	a0, -0(sp) # Restore ofs.3162.7162
	addi	a0, a0, 1
	lw	a1, -8(sp) # Restore or_group.3163.7163
	lw	a2, -4(sp) # Restore dirvec.3164.7164
	jal	x0, solve_one_or_network_fast.3161.7161 
trace_or_matrix_fast.3165.7165: # 22792
	slli	a3, a0, 2
	add	a3, a1, a3
	lw	a3, 0(a3)
	addi	a4, a3, 0
	...
	jalr	x0, ra, 0
be_else.37473:
	sw	a0, -0(sp) # Save ofs.3166.7166
	sw	a2, -4(sp) # Save dirvec.3168.7168
	sw	a1, -8(sp) # Save or_network.3167.7167
	addi	t6, x0, 99
...
beq_cont.37514:
beq_cont.37476:
	lw	a0, -0(sp) # Restore ofs.3166.7166
	addi	a0, a0, 1
	lw	a1, -8(sp) # Restore or_network.3167.7167
	lw	a2, -4(sp) # Restore dirvec.3168.7168
	jal	x0, trace_or_matrix_fast.3165.7165 
trace_reflections.3187.7187: # 23820
	...
	sw	a2, -4(sp) # Save rinfo.4239.8239
	fsw	fa0, -8(sp)
	fsw	fa1, -12(sp)
	sw	a1, -16(sp) # Save dirvec.3191.7191
	sw	a3, -20(sp) # Save m_dvec.5993.9993.12966
	addi	a2, a3, 0
	addi	a1, a5, 0
	addi	a0, a4, 0
	sw	ra, -28(sp)
...
beq_else.37520:
	...
	lw	a1, 0(a1)
	add	a0, a0, a1
	lw	a1, -4(sp) # Restore rinfo.4239.8239
	lw	a2, 0(a1)
	...
	addi	a0, x0, 824
	lw	a1, -20(sp) # Restore m_dvec.5993.9993.12966
	lw	a2, 0(a1)
	addi	a3, a0, 0
	flw	fa0, 0(a3)
	addi	a3, a2, 0
	...
	fmul	fa1, fa1, fa2
	fadd	fa0, fa0, fa1
	lw	a0, -4(sp) # Restore rinfo.4239.8239
	flw	fa1, 8(a0)
	flw	fa2, -8(sp)
	fmul	fa3, fa1, fa2
	fmul	fa0, fa3, fa0
	lw	a0, 0(a1)
	lw	a1, -16(sp) # Restore dirvec.3191.7191
	addi	a2, a1, 0
	flw	fa3, 0(a2)
	addi	a2, a0, 0
	flw	fa4, 0(a2)
...
bg_sub.37532:
	...
	addi	a5, x0, 792
	lw	a5, 0(a5)
	sw	a3, -0(sp) # Save m_sids.6054.10054.12871
	sw	a1, -4(sp) # Save dirvec.3195.7195
	fsw	fa0, -8(sp)
	sw	a0, -12(sp) # Save nref.3193.7193
	sw	a2, -16(sp) # Save pixel.3196.7196
	fsw	fa1, -20(sp)
	addi	a2, a1, 0
	addi	a0, a4, 0
	addi	a1, a5, 0
...
beq_cont.37535:
	...
	addi	a0, x0, -1
	lw	a1, -12(sp) # Restore nref.3193.7193
	slli	a2, a1, 2
	lw	a3, -0(sp) # Restore m_sids.6054.10054.12871
	add	a2, a3, a2
	sw	a0,0(a2) 
...
be_else.37537:
	addi	a0, x0, 568
	lw	a1, -4(sp) # Restore dirvec.3195.7195
	addi	a2, a1, 0
	flw	fa0, 0(a2)
	addi	a2, a0, 0
	flw	fa1, 0(a2)
...
be_else.37536:
	...
	addi	a3, a3, -1
	slli	a3, a3, 2
	lw	a5, -4(sp) # Restore dirvec.3195.7195
	add	a3, a5, a3
	flw	fa2, 0(a3)
	fsgnjn	fs11, fa2, fa2
	feq	a3, fs11, fa2
...
beq_cont.37543:
	...
	addi	a5, a5, 8
	fsw	fa2, 0(a5) 
	sw	a0, -24(sp) # Save obj_id.4104.8104
	sw	a1, -28(sp) # Save obj.4105.8105
	fsw	fa0, -32(sp)
	sw	a2, -36(sp) # Save m_surface.6290.10290.12828
	addi	t6, x0, 1
...
beq_cont.37613:
	...
	flw	fa4, 0(a1)
	fsw	fa3, -88(sp)
	sw	a0, -92(sp) # Save flag00.6568.10568.16140.19059
	fsw	fa0, -96(sp)
	fsw	fa1, -100(sp)
	fsgnj	fa1, fa4, fa4
	fsgnj	fa0, fa3, fa3
...
beq_cont.37621:
	...
	lw	a0, -92(sp) # Restore flag00.6568.10568.16140.19059
	jal	x0, bne_cont.37623
bne_else.37622:
	addi	a0, x0, 1
	lw	a1, -92(sp) # Restore flag00.6568.10568.16140.19059
	sub	a0, a0, a1
bne_cont.37623:
	addi	t6, x0, 1
...
beq_cont.37565:
beq_cont.37557:
	lw	a0, -24(sp) # Restore obj_id.4104.8104
	slli	a0, a0, 2
	addi	a1, x0, 800
	lw	a1, 0(a1)
	add	a0, a0, a1
	...
	add	a2, a3, a2
	sw	a0,0(a2) 
	lw	a0, -16(sp) # Restore pixel.3196.7196
	lw	a2, 4(a0)
	slli	a4, a1, 2
	add	a2, a2, a4
	lw	a2, 0(a2)
	...
	fsw	fa0, 0(a2) 
	lw	a2, 12(a0)
	lw	a4, -28(sp) # Restore obj.4105.8105
	lw	a5, 28(a4)
	flw	fa0, 0(a5)
	luil	a5, l.31279
	srli	a5, a5, 1
...
beq_cont.37690:
	...
	jalr	x0, ra, 0
be_else.37695:
	lw	a0, -12(sp) # Restore nref.3193.7193
	addi	t6, x0, 4
...
bg_else.37697:
	...
	sw	a2,0(a1) 
bg_cont.37698:
	lw	a1, -36(sp) # Restore m_surface.6290.10290.12828
	addi	t6, x0, 2
	...
	addil	a1, a1, l.31213
	flw	fa0, 0(a1)
	lw	a1, -28(sp) # Restore obj.4105.8105
	lw	a1, 28(a1)
	flw	fa2, 0(a1)
	fsub	fa0, fa0, fa2
	fmul	fa0, fa1, fa0
	...
	fadd	fa1, fa2, fa1
	lw	a1, -4(sp) # Restore dirvec.3195.7195
	lw	a2, -16(sp) # Restore pixel.3196.7196
	jal	x0, trace_ray.3192.7192 
be_else.37699:
	jalr	x0, ra, 0
iter_trace_diffuse_rays.3201.7201: # 34544
...
bg_sub.37702:
	...
	fsgnjn	fs11, fa0, fa0
	flt	a4, fa0, fs11
	sw	a3, -0(sp) # Save index.3205.7205
	sw	a2, -4(sp) # Save org.3204.7204
	sw	a1, -8(sp) # Save nvector.3203.7203
	sw	a0, -12(sp) # Save dirvec_group.3202.7202
...
beq_else.37704:
	...
	addi	a6, x0, 792
	lw	a6, 0(a6)
	sw	a4, -16(sp) # Save Tt2216.4061.8061
	fsw	fa0, -20(sp)
	addi	a2, a4, 0
	addi	a1, a6, 0
	addi	a0, a5, 0
...
beq_else.37709:
	...
	addi	a0, a0, 304
	lw	a0, 0(a0)
	lw	a1, -16(sp) # Restore Tt2216.4061.8061
	lw	a1, 0(a1)
	lw	a2, 4(a0)
	addi	t6, x0, 1
...
beq_cont.37782:
	...
	flw	fa4, 0(a1)
	fsw	fa3, -76(sp)
	sw	a0, -80(sp) # Save flag00.6568.10568.27222
	fsw	fa0, -84(sp)
	fsw	fa1, -88(sp)
	fsgnj	fa1, fa4, fa4
	fsgnj	fa0, fa3, fa3
...
beq_cont.37790:
	...
	lw	a0, -80(sp) # Restore flag00.6568.10568.27222
	jal	x0, bne_cont.37792
bne_else.37791:
	addi	a0, x0, 1
	lw	a1, -80(sp) # Restore flag00.6568.10568.27222
	sub	a0, a0, a1
bne_cont.37792:
	addi	t6, x0, 1
...
beq_sub.37706:
	...
	addi	a6, x0, 792
	lw	a6, 0(a6)
	sw	a4, -140(sp) # Save Tt2211.4066.8066
	fsw	fa0, -144(sp)
	addi	a2, a4, 0
	addi	a1, a6, 0
	addi	a0, a5, 0
...
beq_else.37862:
	...
	addi	a0, a0, 304
	lw	a0, 0(a0)
	lw	a1, -140(sp) # Restore Tt2211.4066.8066
	lw	a1, 0(a1)
	lw	a2, 4(a0)
	addi	t6, x0, 1
...
beq_cont.37935:
	...
	flw	fa4, 0(a1)
	fsw	fa3, -200(sp)
	sw	a0, -204(sp) # Save flag00.6568.10568.28035
	fsw	fa0, -208(sp)
	fsw	fa1, -212(sp)
	fsgnj	fa1, fa4, fa4
	fsgnj	fa0, fa3, fa3
...
beq_cont.37943:
	...
	lw	a0, -204(sp) # Restore flag00.6568.10568.28035
	jal	x0, bne_cont.37945
bne_else.37944:
	addi	a0, x0, 1
	lw	a1, -204(sp) # Restore flag00.6568.10568.28035
	sub	a0, a0, a1
bne_cont.37945:
	addi	t6, x0, 1
...
beq_cont.37863:
beq_cont.37705:
	lw	a0, -0(sp) # Restore index.3205.7205
	addi	a3, a0, -2
	lw	a0, -12(sp) # Restore dirvec_group.3202.7202
	lw	a1, -8(sp) # Restore nvector.3203.7203
	lw	a2, -4(sp) # Restore org.3204.7204
	jal	x0, iter_trace_diffuse_rays.3201.7201 
do_without_neighbors.3223.7223: # 51968
	addi	t6, x0, 4
...
beq_else.38015:
	...
	add	a4, a4, a6
	lw	a4, 0(a4)
	sw	a2, -4(sp) # Save Ti2244.4023.8023.11790
	sw	a3, -8(sp) # Save Ta2245.4024.8024.11791
	sw	a4, -12(sp) # Save Ta2246.4025.8025.11792
	sw	a5, -16(sp) # Save m_engy.6040.10040.17739
	sw	a1, -20(sp) # Save nref.3225.7225
...
beq_else.38017:
	...
	lw	a1, -8(sp) # Restore Ta2245.4024.8024.11791
	lw	a2, -12(sp) # Restore Ta2246.4025.8025.11792
	sw	ra, -32(sp)
	addi	sp, sp, -36
	...
	lw	ra, -32(sp)
beq_cont.38018:
	lw	a0, -4(sp) # Restore Ti2244.4023.8023.11790
	addi	t6, x0, 1
...
beq_else.38019:
	...
	lw	a1, 0(a1)
	addi	a2, x0, 904
	lw	a3, -12(sp) # Restore Ta2246.4025.8025.11792
	addi	a4, a3, 0
	flw	fa0, 0(a4)
	addi	a4, a2, 0
	fsw	fa0, 0(a4) 
...
beq_cont.38026:
	addi	a0, x0, 860
	lw	a1, -20(sp) # Restore nref.3225.7225
	slli	a2, a1, 2
	lw	a3, -16(sp) # Restore m_engy.6040.10040.17739
	add	a2, a3, a2
	lw	a2, 0(a2)
	addi	a3, x0, 848
	addi	a4, a0, 0
...
bg_else.38013:
	jalr	x0, ra, 0
try_exploit_neighbors.3239.7239: # 53120
	slli	a6, a0, 2
	add	a6, a3, a6
	lw	a6, 0(a6)
	addi	t6, x0, 4
...
bg_else.38029:
	jalr	x0, ra, 0
pretrace_diffuse_rays.3254.7254: # 54132
	addi	t6, x0, 4
...
bg_else.38044:
	jalr	x0, ra, 0
pretrace_pixels.3257.7257: # 54520
...
beq_cont.38052:
	...
	addil	a6, a6, l.31154
	flw	fa4, 0(a6)
	sw	a1, -0(sp) # Save x.3259.7259
	sw	a2, -4(sp) # Save group_id.3260.7260
	fsw	fa2, -8(sp)
	fsw	fa1, -12(sp)
	fsw	fa0, -16(sp)
	sw	a0, -20(sp) # Save line.3258.7258
	addi	a2, a5, 0
	addi	a1, a4, 0
	addi	a0, a3, 0
	fsgnj	fa1, fa4, fa4
	...
	addi	sp, sp, 32
	lw	ra, -28(sp)
	lw	a0, -0(sp) # Restore x.3259.7259
	slli	a1, a0, 2
	lw	a2, -20(sp) # Restore line.3258.7258
	add	a1, a2, a1
	lw	a1, 0(a1)
	lw	a1, 0(a1)
	addi	a3, x0, 860
	...
	lw	a1, 0(a1)
	lw	a1, 24(a1)
	lw	a3, -4(sp) # Restore group_id.3260.7260
	sw	a3,0(a1) 
	slli	a1, a0, 2
	add	a1, a2, a1
	lw	a1, 0(a1)
	...
	lw	a0, -0(sp) # Restore x.3259.7259
	addi	a1, a0, -1
	lw	a0, -4(sp) # Restore group_id.3260.7260
	addi	a0, a0, 1
	addi	t6, x0, 5
...
bg_cont.38054:
	...
	flw	fa1, -12(sp)
	flw	fa2, -8(sp)
	lw	a0, -20(sp) # Restore line.3258.7258
	jal	x0, pretrace_pixels.3257.7257 
bg_else.38050:
	jalr	x0, ra, 0
scan_pixel.3268.7268: # 55224
	addi	a6, x0, 872
	lw	a6, 0(a6)
...
bg_cont.38061:
bg_cont.38059:
	sw	a5, -0(sp) # Save version.3274.7274
	sw	a1, -4(sp) # Save y.3270.7270
	sw	a2, -8(sp) # Save prev.3271.7271
	sw	a3, -12(sp) # Save cur.3272.7272
	sw	a4, -16(sp) # Save next.3273.7273
	sw	a0, -20(sp) # Save x.3269.7269
...
beq_else.38066:
	...
	lw	ra, -28(sp)
beq_cont.38067:
	lw	a5, -0(sp) # Restore version.3274.7274
	addi	t6, x0, 3
...
bg_cont.38091:
	sw	a0, 0(s11)
beq_cont.38069:
	lw	a0, -20(sp) # Restore x.3269.7269
	addi	a0, a0, 1
	lw	a1, -4(sp) # Restore y.3270.7270
	lw	a2, -8(sp) # Restore prev.3271.7271
	lw	a3, -12(sp) # Restore cur.3272.7272
	lw	a4, -16(sp) # Restore next.3273.7273
	jal	x0, scan_pixel.3268.7268 
scan_line.3275.7275: # 55840
	addi	a6, x0, 872
	addi	a6, a6, 4
	lw	a6, 0(a6)
...
init_line_elements.3286.7286: # 56192
...
beq_cont.38152:
	...
	fsw	fa0, -8(sp)
	fsw	fa2, -12(sp)
	sw	a2, -16(sp) # Save index.3303.7303
	sw	a1, -20(sp) # Save group_id.3302.7302
	fsw	fa3, -24(sp)
	sw	a0, -28(sp) # Save icount.3297.7297
	fsgnj	fa1, fa5, fa5
	fsgnj	fa0, fa4, fa4
	sw	ra, -36(sp)
	addi	sp, sp, -40
...
beq_cont.38194:
	...
	flw	fa4, 0(a1)
	fsw	fa3, -72(sp)
	sw	a0, -76(sp) # Save flag00.6568.10568.26426
	fsw	fa0, -80(sp)
	fsw	fa1, -84(sp)
	fsgnj	fa1, fa4, fa4
	fsgnj	fa0, fa3, fa3
...
beq_cont.38202:
	...
	lw	a0, -76(sp) # Restore flag00.6568.10568.26426
	jal	x0, bne_cont.38204
bne_else.38203:
	addi	a0, x0, 1
	lw	a1, -76(sp) # Restore flag00.6568.10568.26426
	sub	a0, a0, a1
bne_cont.38204:
	addi	t6, x0, 1
...
beq_cont.38206:
	...
	flw	fa1, -8(sp)
	fmul	fa0, fa0, fa1
	lw	a0, -28(sp) # Restore icount.3297.7297
	addi	a0, a0, 1
	fmul	fa1, fa0, fa0
	luil	a1, l.33267
	srli	a1, a1, 1
...
beq_cont.38244:
	...
	fsw	fa1, -144(sp)
	fsw	fa0, -148(sp)
	sw	a0, -152(sp) # Save Ti2573.3593.7593
	fsgnj	fa1, fa5, fa5
	fsgnj	fa0, fa4, fa4
	sw	ra, -160(sp)
	addi	sp, sp, -164
...
beq_cont.38286:
	...
	flw	fa4, 0(a1)
	fsw	fa3, -196(sp)
	sw	a0, -200(sp) # Save flag00.6568.10568.26050
	fsw	fa0, -204(sp)
	fsw	fa1, -208(sp)
	fsgnj	fa1, fa4, fa4
	fsgnj	fa0, fa3, fa3
...
beq_cont.38294:
	...
	lw	a0, -200(sp) # Restore flag00.6568.10568.26050
	jal	x0, bne_cont.38296
bne_else.38295:
	addi	a0, x0, 1
	lw	a1, -200(sp) # Restore flag00.6568.10568.26050
	sub	a0, a0, a1
bne_cont.38296:
	addi	t6, x0, 1
...
beq_cont.38298:
	...
	flw	fa2, -12(sp)
	flw	fa3, -24(sp)
	lw	a0, -152(sp) # Restore Ti2573.3593.7593
	lw	a1, -20(sp) # Restore group_id.3302.7302
	lw	a2, -16(sp) # Restore index.3303.7303
	jal	x0, calc_dirvec.3296.7296 
calc_dirvecs.3304.7304: # 67360
	...
	addil	a4, a4, l.31154
	flw	fa3, 0(a4)
	sw	a0, -0(sp) # Save col.3305.7305
	sw	a2, -4(sp) # Save index.3308.7308
	fsw	fa0, -8(sp)
	sw	a1, -12(sp) # Save group_id.3307.7307
	addi	a0, a3, 0
	fsgnj	fs11, fa3, fa3
	fsgnj	fa3, fa0, fa0
	fsgnj	fa0, fa1, fa1
	...
	addi	sp, sp, 24
	lw	ra, -20(sp)
	lw	a0, -0(sp) # Restore col.3305.7305
	fcvtsw	fa0, a0
	luil	a1, l.32822
	srli	a1, a1, 1
	addil	a1, a1, l.32822
	...
	addil	a2, a2, l.31154
	flw	fa1, 0(a2)
	lw	a2, -4(sp) # Restore index.3308.7308
	addi	a3, a2, 2
	flw	fa3, -8(sp)
	lw	a4, -12(sp) # Restore group_id.3307.7307
	addi	a2, a3, 0
	addi	a0, a1, 0
	addi	a1, a4, 0
	sw	ra, -20(sp)
	...
	lw	a0, -0(sp) # Restore col.3305.7305
	addi	a0, a0, -1
	lw	a1, -12(sp) # Restore group_id.3307.7307
	addi	a1, a1, 1
	addi	t6, x0, 5
...
bg_else.38315:
	jalr	x0, ra, 0
calc_dirvec_rows.3309.7309: # 67680
	...
	fsub	fa0, fa0, fa1
	addi	a3, x0, 4
	sw	a0, -0(sp) # Save row.3310.7310
	sw	a2, -4(sp) # Save index.3312.7312
	sw	a1, -8(sp) # Save group_id.3311.7311
	addi	a0, a3, 0
	sw	ra, -16(sp)
	addi	sp, sp, -20
	...
	addi	sp, sp, 20
	lw	ra, -16(sp)
	lw	a0, -0(sp) # Restore row.3310.7310
	addi	a0, a0, -1
	lw	a1, -8(sp) # Restore group_id.3311.7311
	addi	a1, a1, 2
	addi	t6, x0, 5
...
bg_else.38320:
bg_cont.38321:
	lw	a2, -4(sp) # Restore index.3312.7312
	addi	a2, a2, 4
	jal	x0, calc_dirvec_rows.3309.7309 
bg_else.38319:
	jalr	x0, ra, 0
create_dirvec_elements.3315.7315: # 67816
...
bg_else.38323:
	jalr	x0, ra, 0
create_dirvecs.3318.7318: # 67964
...
bg_else.38327:
	jalr	x0, ra, 0
init_dirvec_constants.3320.7320: # 68632
	...
	lw	a3, 0(a3)
	addi	a3, a3, -1
	sw	a1, -0(sp) # Save index.3322.7322
	sw	a0, -4(sp) # Save vecset.3321.7321
	addi	a1, a3, 0
	addi	a0, a2, 0
	sw	ra, -12(sp)
	addi	sp, sp, -16
	...
	addi	sp, sp, 16
	lw	ra, -12(sp)
	lw	a0, -0(sp) # Restore index.3322.7322
	addi	a1, a0, -1
	lw	a0, -4(sp) # Restore vecset.3321.7321
	jal	x0, init_dirvec_constants.3320.7320 
bg_else.38332:
	jalr	x0, ra, 0
init_vecset_constants.3323.7323: # 68716
...
beq_cont.38472:
	...
	flw	fa4, 0(a1)
	fsw	fa3, -156(sp)
	sw	a0, -160(sp) # Save flag00.6568.10568.16140.25541
	fsw	fa0, -164(sp)
	fsw	fa1, -168(sp)
	fsgnj	fa1, fa4, fa4
	fsgnj	fa0, fa3, fa3
...
beq_cont.38480:
	...
	lw	a0, -160(sp) # Restore flag00.6568.10568.16140.25541
	jal	x0, bne_cont.38482
bne_else.38481:
	addi	a0, x0, 1
	lw	a1, -160(sp) # Restore flag00.6568.10568.16140.25541
	sub	a0, a0, a1
bne_cont.38482:
	addi	t6, x0, 1
...
beq_cont.38546:
	...
	flw	fa4, 0(a1)
	fsw	fa3, -272(sp)
	sw	a0, -276(sp) # Save flag00.6568.10568.16140.25317
	fsw	fa0, -280(sp)
	fsw	fa1, -284(sp)
	fsgnj	fa1, fa4, fa4
	fsgnj	fa0, fa3, fa3
...
beq_cont.38554:
	...
	lw	a0, -276(sp) # Restore flag00.6568.10568.16140.25317
	jal	x0, bne_cont.38556
bne_else.38555:
	addi	a0, x0, 1
	lw	a1, -276(sp) # Restore flag00.6568.10568.16140.25317
	sub	a0, a0, a1
bne_cont.38556:
	addi	t6, x0, 1
...
beq_cont.38656:
	...
	flw	fa4, 0(a1)
	fsw	fa3, -412(sp)
	sw	a0, -416(sp) # Save flag00.6568.10568.16140.24987
	fsw	fa0, -420(sp)
	fsw	fa1, -424(sp)
	fsgnj	fa1, fa4, fa4
	fsgnj	fa0, fa3, fa3
...
beq_cont.38664:
	...
	lw	a0, -416(sp) # Restore flag00.6568.10568.16140.24987
	jal	x0, bne_cont.38666
bne_else.38665:
	addi	a0, x0, 1
	lw	a1, -416(sp) # Restore flag00.6568.10568.16140.24987
	sub	a0, a0, a1
bne_cont.38666:
	addi	t6, x0, 1
...
beq_cont.38730:
	...
	flw	fa4, 0(a1)
	fsw	fa3, -520(sp)
	sw	a0, -524(sp) # Save flag00.6568.10568.16140.24764
	fsw	fa0, -528(sp)
	fsw	fa1, -532(sp)
	fsgnj	fa1, fa4, fa4
	fsgnj	fa0, fa3, fa3
...
beq_cont.38738:
	...
	lw	a0, -524(sp) # Restore flag00.6568.10568.16140.24764
	jal	x0, bne_cont.38740
bne_else.38739:
	addi	a0, x0, 1
	lw	a1, -524(sp) # Restore flag00.6568.10568.16140.24764
	sub	a0, a0, a1
bne_cont.38740:
	addi	t6, x0, 1
...
beq_else.38763:
	...
	fsw	fa3, -596(sp)
	fsw	fa0, -600(sp)
	sw	a1, -604(sp) # Save Ti2663.3481.7481.11025.16432
	sw	a2, -608(sp) # Save nr.3455.7455.11008.16415
	sw	a0, -612(sp) # Save sid.3454.7454.11005.16412
	fsw	fa1, -616(sp)
	fsw	fa5, 0(hp)
	fsw	fa5, 4(hp)
	fsw	fa5, 8(hp)
...
create_array_end.38768:
	...
	sw	a1,4(a0) 
	lw	a1, -604(sp) # Restore Ti2663.3481.7481.11025.16432
	sw	a1,0(a0) 
	lw	a1, -608(sp) # Restore nr.3455.7455.11008.16415
	slli	a2, a1, 2
	addi	a2, a2, 1264
	sw	a0,0(a2) 
	addi	a0, a1, 1
	lw	a2, -612(sp) # Restore sid.3454.7454.11005.16412
	addi	a3, a2, 2
	addi	a4, x0, 568
	addi	a4, a4, 4
	flw	fa1, 0(a4)
...
create_array_end.38770:
	...
	addi	a1, a1, 1264
	sw	a0,0(a1) 
	lw	a0, -608(sp) # Restore nr.3455.7455.11008.16415
	addi	a1, a0, 2
	lw	a2, -612(sp) # Restore sid.3454.7454.11005.16412
	addi	a2, a2, 3
	addi	a3, x0, 568
...
beq_else.38765:
	...
	fsw	fa1, -676(sp)
	fsw	fa0, -680(sp)
	sw	a0, -684(sp) # Save sid.3412.7412.10965.16372
	sw	a2, -688(sp) # Save nr.3413.7413.10968.16375
	fsw	fa4, 0(hp)
	fsw	fa4, 4(hp)
	fsw	fa4, 8(hp)
	addi	a0, hp, 0
...
create_array_end.38776:
	...
	sw	a1,4(a0) 
	lw	a1, -684(sp) # Restore sid.3412.7412.10965.16372
	sw	a1,0(a0) 
	lw	a1, -688(sp) # Restore nr.3413.7413.10968.16375
	slli	a2, a1, 2
	addi	a2, a2, 1264
	sw	a0,0(a2) 
	addi	a0, x0, 1984
