...
bg_else.27428:
	lw	a1, 0(s10)
	sw	a0, -0(sp) #save offset of n.2801.6570
	addi	t6, x0, -1
...
beq_else.27430:
	...
	addil	a6, a6, l.23583
	flw	fa0, 0(a6)
	sw	a1, -4(sp) #save offset of texture.5440.9209.15040
	sw	a3, -8(sp) #save offset of refltype.5443.9212.15046
	sw	a2, -12(sp) #save offset of form.5442.9211.15044
	sw	a4, -16(sp) #save offset of isrot_p.5444.9213.15048
	addi	t6, hp, 0
...
create_float_array_end.27432:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -20(sp) #save offset of abc.5445.9214.15051
	addi	t6, hp, 0
...
create_float_array_end.27433:
	...
	addil	a3, a3, l.23583
	flw	fa0, 0(a3)
	sw	a0, -24(sp) #save offset of xyz.5449.9218.15066
	sw	a1, -28(sp) #save offset of m_invert.5453.9222.15081
	addi	t6, hp, 0
...
create_float_array_end.27434:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -32(sp) #save offset of reflparam.5454.9223.15084
	addi	t6, hp, 0
...
create_float_array_end.27435:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -36(sp) #save offset of color.5457.9226.15095
	addi	t6, hp, 0
...
create_float_array_end.27436:
	addi	a0, t6, 0
	lw	a1, -16(sp) #restore offset of isrot_p.5444.9213.15048
	addi	t6, x0, 0
...
beq_else.27437:
	...
	fsw	fa0, 0(a2) 
beq_cont.27438:
	lw	a2, -12(sp) #restore offset of form.5442.9211.15044
	addi	t6, x0, 2
	...
	addi	x0, x0, 0
beq_else.27439:
	lw	a3, -28(sp) #restore offset of m_invert.5453.9222.15081
beq_cont.27440:
	addi	a4, x0, 4
	luil	a5, l.23583
	srli	a5, a5, 1
	addil	a5, a5, l.23583
	flw	fa0, 0(a5)
	sw	a3, -40(sp) #save offset of m_invert2.5463.9232.15114
	sw	a0, -44(sp) #save offset of rotation.5461.9230.15110
	addi	t6, hp, 0
...
create_float_array_end.27441:
	...
	addi	hp, hp, 44
	sw	a0,40(a1) 
	lw	a0, -44(sp) #restore offset of rotation.5461.9230.15110
	sw	a0,36(a1) 
	lw	a2, -36(sp) #restore offset of color.5457.9226.15095
	sw	a2,32(a1) 
	lw	a2, -32(sp) #restore offset of reflparam.5454.9223.15084
	sw	a2,28(a1) 
	lw	a2, -40(sp) #restore offset of m_invert2.5463.9232.15114
	sw	a2,24(a1) 
	lw	a2, -24(sp) #restore offset of xyz.5449.9218.15066
	sw	a2,20(a1) 
	lw	a2, -20(sp) #restore offset of abc.5445.9214.15051
	sw	a2,16(a1) 
	lw	a3, -16(sp) #restore offset of isrot_p.5444.9213.15048
	sw	a3,12(a1) 
	lw	a4, -8(sp) #restore offset of refltype.5443.9212.15046
	sw	a4,8(a1) 
	lw	a4, -12(sp) #restore offset of form.5442.9211.15044
	sw	a4,4(a1) 
	lw	a5, -4(sp) #restore offset of texture.5440.9209.15040
	sw	a5,0(a1) 
	lw	a5, -0(sp) #restore offset of n.2801.6570
	slli	a6, a5, 2
	addi	a6, a6, 304
	sw	a1,0(a6) 
	addi	t6, x0, 3
...
beq_else.27442:
	...
	addi	x0, x0, 0
	lw	a1, -28(sp) #restore offset of m_invert.5453.9222.15081
	addi	t6, x0, 0
...
beq_else.27470:
	...
	addi	a1, a0, 0
	flw	fa1, 0(a1)
	fsw	fa0, -48(sp) #savef offset of cos_x.5569.9338.21469
	fsgnj	fa0, fa1, fa1
	sw	ra, -56(sp)
	addi	sp, sp, -60
	jal	ra, min_caml_sin
	...
	addi	a1, a0, 4
	flw	fa1, 0(a1)
	fsw	fa0, -52(sp) #savef offset of sin_x.5570.9339.21472
	fsgnj	fa0, fa1, fa1
	sw	ra, -60(sp)
	addi	sp, sp, -64
	jal	ra, min_caml_cos
	...
	addi	a1, a0, 4
	flw	fa1, 0(a1)
	fsw	fa0, -56(sp) #savef offset of cos_y.5571.9340.21475
	fsgnj	fa0, fa1, fa1
	sw	ra, -64(sp)
	addi	sp, sp, -68
	jal	ra, min_caml_sin
	...
	addi	a1, a0, 8
	flw	fa1, 0(a1)
	fsw	fa0, -60(sp) #savef offset of sin_y.5572.9341.21478
	fsgnj	fa0, fa1, fa1
	sw	ra, -68(sp)
	addi	sp, sp, -72
	jal	ra, min_caml_cos
	...
	addi	a1, a0, 8
	flw	fa1, 0(a1)
	fsw	fa0, -64(sp) #savef offset of cos_z.5573.9342.21481
	fsgnj	fa0, fa1, fa1
	sw	ra, -72(sp)
	addi	sp, sp, -76
	jal	ra, min_caml_sin
	addi	sp, sp, 76
	lw	ra, -72(sp)
	flw	fa1, -64(sp) # restoref offset of cos_z.5573.9342.21481
	flw	fa2, -56(sp) # restoref offset of cos_y.5571.9340.21475
	fmul	fa3, fa2, fa1
	flw	fa4, -60(sp) # restoref offset of sin_y.5572.9341.21478
	flw	fa5, -52(sp) # restoref offset of sin_x.5570.9339.21472
	fmul	fa6, fa5, fa4
	fmul	fa6, fa6, fa1
	flw	fa7, -48(sp) # restoref offset of cos_x.5569.9338.21469
	fmul	ft0, fa7, fa0
	fsub	fa6, fa6, ft0
	fmul	ft0, fa7, fa4
	fmul	ft0, ft0, fa1
	...
	fmul	fa4, fa5, fa2
	fmul	fa2, fa7, fa2
	lw	a0, -20(sp) #restore offset of abc.5445.9214.15051
	addi	a1, a0, 0
	flw	fa5, 0(a1)
	addi	a1, a0, 4
	flw	fa7, 0(a1)
...
beq_cont.27431:
	...
	addi	a0, x0, 256
	addi	a0, a0, 0
	lw	a1, -0(sp) #restore offset of n.2801.6570
	sw	a1,0(a0) 
	jalr	x0, ra, 0
	addi	x0, x0, 0
be_else.27472:
	lw	a0, -0(sp) #restore offset of n.2801.6570
	addi	a0, a0, 1
...
be_else.27474:
	addi	a2, a0, 1
	sw	a1, -0(sp) #save offset of item.5420.9189
	sw	a0, -4(sp) #save offset of length.2805.6574
	addi	a0, a2, 0
	sw	ra, -12(sp)
	addi	sp, sp, -16
	...
	addi	sp, sp, 16
	lw	ra, -12(sp)
	lw	a1, -4(sp) #restore offset of length.2805.6574
	slli	a1, a1, 2
	add	a1, a0, a1
	lw	a2, -0(sp) #restore offset of item.5420.9189
	sw	a2,0(a1) 
	jalr	x0, ra, 0
	addi	x0, x0, 0
read_or_network.2806.6575:
	addi	a1, x0, 0
	sw	a0, -0(sp) #save offset of length.2807.6576
	addi	a0, a1, 0
	sw	ra, -8(sp)
	addi	sp, sp, -12
	jal	ra, read_net_item.2804.6573
	...
	lw	a1, -0(sp) #restore offset of length.2807.6576
	addi	a1, a1, 1
	addi	t6, hp, 0
...
be_else.27476:
	lw	a1, -0(sp) #restore offset of length.2807.6576
	addi	a2, a1, 1
	sw	a0, -4(sp) #save offset of net.5408.9177
	addi	a0, a2, 0
	sw	ra, -12(sp)
	addi	sp, sp, -16
	...
	slli	a1, a1, 2
	add	a1, a0, a1
	lw	a2, -4(sp) #restore offset of net.5408.9177
	sw	a2,0(a1) 
	jalr	x0, ra, 0
	addi	x0, x0, 0
read_and_network.2808.6577:
	addi	a1, x0, 0
	sw	a0, -0(sp) #save offset of n.2809.6578
	addi	a0, a1, 0
	sw	ra, -8(sp)
	addi	sp, sp, -12
	jal	ra, read_net_item.2804.6573
	...
	addi	x0, x0, 0
be_else.27478:
	lw	a1, -0(sp) #restore offset of n.2809.6578
	slli	a2, a1, 2
	addi	a2, a2, 588
	sw	a0,0(a2) 
	addi	a0, a1, 1
...
iter_setup_dirvec_constants.2905.6674:
	...
	lw	a4, 0(a0)
	lw	a5, 4(a2)
	sw	a0, -0(sp) #save offset of dirvec.2906.6675
	addi	t6, x0, 1
	...
	addil	a6, a6, l.23583
	flw	fa0, 0(a6)
	sw	a3, -4(sp) #save offset of m_const.5814.9583.13591
	sw	a1, -8(sp) #save offset of index.2907.6676
	sw	a2, -12(sp) #save offset of m.4787.8556
	sw	a4, -16(sp) #save offset of m_vec.5815.9584.13588
	addi	t6, hp, 0
...
create_float_array_end.27483:
	addi	a0, t6, 0
	lw	a1, -16(sp) #restore offset of m_vec.5815.9584.13588
	addi	a2, a1, 0
	flw	fa0, 0(a2)
	fsgnjn	fs11, fa0, fa0
	feq	a2, fs11, fa0
	...
	addi	x0, x0, 0
	lw	a2, -12(sp) #restore offset of m.4787.8556
	lw	a3, 24(a2)
	addi	a4, a1, 0
	flw	fa0, 0(a4)
	fsgnjn	fs11, fa0, fa0
...
beq_else.27500:
	...
	fsw	fa0, 0(a1) 
beq_cont.27501:
	lw	a1, -8(sp) #restore offset of index.2907.6676
	slli	a2, a1, 2
	lw	a3, -4(sp) #restore offset of m_const.5814.9583.13591
	add	a2, a3, a2
	sw	a0,0(a2) 
...
beq_cont.27482:
	addi	a1, a1, -1
	lw	a0, -0(sp) #restore offset of dirvec.2906.6675
...
be_else.27604:
	...
	fadd	fa0, fa0, fa3
	addi	a2, x0, 0
	sw	a1, -0(sp) #save offset of and_group.2943.6712
	sw	a0, -4(sp) #save offset of iand_ofs.2942.6711
	addi	a0, a2, 0
	fsgnj	fs11, fa2, fa2
	fsgnj	fa2, fa0, fa0
	fsgnj	fa0, fa1, fa1
	...
	lw	a0, -4(sp) #restore offset of iand_ofs.2942.6711
	addi	a0, a0, 1
	lw	a1, -0(sp) #restore offset of and_group.2943.6712
	jal	x0, shadow_check_and_group.2941.6710 
be_else.27606:
	addi	a0, x0, 1
	jalr	x0, ra, 0
...
be_else.27607:
	...
	lw	a2, 0(a2)
	addi	a3, x0, 0
	sw	a1, -0(sp) #save offset of or_group.2946.6715
	sw	a0, -4(sp) #save offset of ofs.2945.6714
	addi	a1, a2, 0
	addi	a0, a3, 0
	sw	ra, -12(sp)
	addi	sp, sp, -16
	...
	lw	a0, -4(sp) #restore offset of ofs.2945.6714
	addi	a0, a0, 1
	lw	a1, -0(sp) #restore offset of or_group.2946.6715
...
shadow_check_one_or_matrix.2947.6716:
	...
	addi	x0, x0, 0
be_else.27609:
	sw	a2, -0(sp) #save offset of head.4590.8359
	sw	a1, -4(sp) #save offset of or_matrix.2949.6718
	sw	a0, -8(sp) #save offset of ofs.2948.6717
	addi	t6, x0, 99
...
beq_cont.27611:
	...
	lw	a0, -8(sp) #restore offset of ofs.2948.6717
	addi	a0, a0, 1
	lw	a1, -4(sp) #restore offset of or_matrix.2949.6718
	jal	x0, shadow_check_one_or_matrix.2947.6716 
be_else.27658:
	addi	a0, x0, 1
	lw	a1, -0(sp) #restore offset of head.4590.8359
	sw	ra, -16(sp)
	addi	sp, sp, -20
	jal	ra, shadow_check_one_or_group.2944.6713
	addi	sp, sp, 20
...
be_else.27724:
	...
	flw	fa1, 0(a5)
	flt	a5, fa1, fa0
	sw	a2, -0(sp) #save offset of dirvec.2953.6722
	sw	a1, -4(sp) #save offset of and_group.2952.6721
	sw	a0, -8(sp) #save offset of iand_ofs.2951.6720
	addi	t6, x0, 0
...
beq_else.27729:
	...
	fadd	fa3, fa3, fa4
	addi	a5, x0, 0
	sw	a4, -12(sp) #save offset of t0.4530.8299
	sw	a3, -16(sp) #save offset of iobj.4528.8297
	fsw	fa3, -20(sp) #savef offset of q2.4543.8312
	fsw	fa2, -24(sp) #savef offset of q1.4542.8311
	fsw	fa1, -28(sp) #savef offset of q0.4541.8310
	fsw	fa0, -32(sp) #savef offset of t.4540.8309
	addi	a0, a5, 0
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	fsgnj	fa2, fa3, fa3
...
beq_else.27731:
	addi	a0, x0, 804
	addi	a0, a0, 0
	flw	fa0, -32(sp) # restoref offset of t.4540.8309
	fsw	fa0, 0(a0) 
	addi	a0, x0, 808
	addi	a1, a0, 0
	flw	fa0, -28(sp) # restoref offset of q0.4541.8310
	fsw	fa0, 0(a1) 
	addi	a1, a0, 4
	flw	fa0, -24(sp) # restoref offset of q1.4542.8311
	fsw	fa0, 0(a1) 
	addi	a0, a0, 8
	flw	fa0, -20(sp) # restoref offset of q2.4543.8312
	fsw	fa0, 0(a0) 
	addi	a0, x0, 820
	addi	a0, a0, 0
	lw	a1, -16(sp) #restore offset of iobj.4528.8297
	sw	a1,0(a0) 
	addi	a0, x0, 800
	addi	a0, a0, 0
	lw	a1, -12(sp) #restore offset of t0.4530.8299
	sw	a1,0(a0) 
beq_cont.27732:
beq_cont.27730:
beq_cont.27728:
	lw	a0, -8(sp) #restore offset of iand_ofs.2951.6720
	addi	a0, a0, 1
	lw	a1, -4(sp) #restore offset of and_group.2952.6721
	lw	a2, -0(sp) #restore offset of dirvec.2953.6722
	jal	x0, solve_each_element.2950.6719 
...
be_else.27733:
	...
	lw	a3, 0(a3)
	addi	a4, x0, 0
	sw	a2, -0(sp) #save offset of dirvec.2957.6726
	sw	a1, -4(sp) #save offset of or_group.2956.6725
	sw	a0, -8(sp) #save offset of ofs.2955.6724
	addi	a1, a3, 0
	addi	a0, a4, 0
	sw	ra, -16(sp)
	addi	sp, sp, -20
	...
	addi	sp, sp, 20
	lw	ra, -16(sp)
	lw	a0, -8(sp) #restore offset of ofs.2955.6724
	addi	a0, a0, 1
	lw	a1, -4(sp) #restore offset of or_group.2956.6725
	lw	a2, -0(sp) #restore offset of dirvec.2957.6726
...
trace_or_matrix.2958.6727:
	...
	addi	x0, x0, 0
be_else.27735:
	sw	a2, -0(sp) #save offset of dirvec.2961.6730
	sw	a1, -4(sp) #save offset of or_network.2960.6729
	sw	a0, -8(sp) #save offset of ofs.2959.6728
	addi	t6, x0, 99
...
beq_cont.27802:
beq_cont.27738:
	lw	a0, -8(sp) #restore offset of ofs.2959.6728
	addi	a0, a0, 1
	lw	a1, -4(sp) #restore offset of or_network.2960.6729
	lw	a2, -0(sp) #restore offset of dirvec.2961.6730
...
be_else.27843:
	...
	flw	fa1, 0(a6)
	flt	a6, fa1, fa0
	sw	a2, -0(sp) #save offset of dirvec.2967.6736
	sw	a1, -4(sp) #save offset of and_group.2966.6735
	sw	a0, -8(sp) #save offset of iand_ofs.2965.6734
	addi	t6, x0, 0
...
beq_else.27848:
	...
	fadd	fa3, fa3, fa4
	addi	a3, x0, 0
	sw	a5, -12(sp) #save offset of t0.4422.8191
	sw	a4, -16(sp) #save offset of iobj.4420.8189
	fsw	fa3, -20(sp) #savef offset of q2.4435.8204
	fsw	fa2, -24(sp) #savef offset of q1.4434.8203
	fsw	fa1, -28(sp) #savef offset of q0.4433.8202
	fsw	fa0, -32(sp) #savef offset of t.4432.8201
	addi	a0, a3, 0
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fa2, fa2
	fsgnj	fa2, fa3, fa3
...
beq_else.27850:
	addi	a0, x0, 804
	addi	a0, a0, 0
	flw	fa0, -32(sp) # restoref offset of t.4432.8201
	fsw	fa0, 0(a0) 
	addi	a0, x0, 808
	addi	a1, a0, 0
	flw	fa0, -28(sp) # restoref offset of q0.4433.8202
	fsw	fa0, 0(a1) 
	addi	a1, a0, 4
	flw	fa0, -24(sp) # restoref offset of q1.4434.8203
	fsw	fa0, 0(a1) 
	addi	a0, a0, 8
	flw	fa0, -20(sp) # restoref offset of q2.4435.8204
	fsw	fa0, 0(a0) 
	addi	a0, x0, 820
	addi	a0, a0, 0
	lw	a1, -16(sp) #restore offset of iobj.4420.8189
	sw	a1,0(a0) 
	addi	a0, x0, 800
	addi	a0, a0, 0
	lw	a1, -12(sp) #restore offset of t0.4422.8191
	sw	a1,0(a0) 
beq_cont.27851:
beq_cont.27849:
beq_cont.27847:
	lw	a0, -8(sp) #restore offset of iand_ofs.2965.6734
	addi	a0, a0, 1
	lw	a1, -4(sp) #restore offset of and_group.2966.6735
	lw	a2, -0(sp) #restore offset of dirvec.2967.6736
	jal	x0, solve_each_element_fast.2964.6733 
...
be_else.27852:
	...
	lw	a3, 0(a3)
	addi	a4, x0, 0
	sw	a2, -0(sp) #save offset of dirvec.2971.6740
	sw	a1, -4(sp) #save offset of or_group.2970.6739
	sw	a0, -8(sp) #save offset of ofs.2969.6738
	addi	a1, a3, 0
	addi	a0, a4, 0
	sw	ra, -16(sp)
	addi	sp, sp, -20
	...
	addi	sp, sp, 20
	lw	ra, -16(sp)
	lw	a0, -8(sp) #restore offset of ofs.2969.6738
	addi	a0, a0, 1
	lw	a1, -4(sp) #restore offset of or_group.2970.6739
	lw	a2, -0(sp) #restore offset of dirvec.2971.6740
...
trace_or_matrix_fast.2972.6741:
	...
	addi	x0, x0, 0
be_else.27854:
	sw	a2, -0(sp) #save offset of dirvec.2975.6744
	sw	a1, -4(sp) #save offset of or_network.2974.6743
	sw	a0, -8(sp) #save offset of ofs.2973.6742
	addi	t6, x0, 99
...
beq_cont.27895:
beq_cont.27857:
	lw	a0, -8(sp) #restore offset of ofs.2973.6742
	addi	a0, a0, 1
	lw	a1, -4(sp) #restore offset of or_network.2974.6743
	lw	a2, -0(sp) #restore offset of dirvec.2975.6744
...
trace_reflections.2994.6763:
	...
	addi	a5, a5, 0
	lw	a5, 0(a5)
	sw	a0, -0(sp) #save offset of index.2995.6764
	fsw	fa1, -4(sp) #savef offset of hilight_scale.2997.6766
	sw	a1, -8(sp) #save offset of dirvec.2998.6767
	fsw	fa0, -12(sp) #savef offset of diffuse.2996.6765
	sw	a3, -16(sp) #save offset of m_dvec.5808.9577.12372
	sw	a2, -20(sp) #save offset of rinfo.4054.7823
	addi	a2, a3, 0
	addi	a1, a5, 0
	addi	a0, a4, 0
	sw	ra, -28(sp)
...
beq_else.27901:
	...
	lw	a1, 0(a1)
	add	a0, a0, a1
	lw	a1, -20(sp) #restore offset of rinfo.4054.7823
	lw	a2, 0(a1)
	...
	addi	x0, x0, 0
	addi	a0, x0, 824
	lw	a1, -16(sp) #restore offset of m_dvec.5808.9577.12372
	lw	a2, 0(a1)
	addi	a3, a0, 0
	flw	fa0, 0(a3)
	addi	a3, a2, 0
	...
	fmul	fa1, fa1, fa2
	fadd	fa0, fa0, fa1
	lw	a0, -20(sp) #restore offset of rinfo.4054.7823
	flw	fa1, 8(a0)
	flw	fa2, -12(sp) # restoref offset of diffuse.2996.6765
	fmul	fa3, fa1, fa2
	fmul	fa0, fa3, fa0
	lw	a0, 0(a1)
	lw	a1, -8(sp) #restore offset of dirvec.2998.6767
	addi	a2, a1, 0
	flw	fa3, 0(a2)
	addi	a2, a0, 0
	flw	fa4, 0(a2)
...
beq_else.27909:
	fmul	fa0, fa1, fa1
	fmul	fa0, fa0, fa0
	flw	fa1, -4(sp) # restoref offset of hilight_scale.2997.6766
	fmul	fa0, fa0, fa1
	addi	a0, x0, 860
	addi	a2, x0, 860
	addi	a2, a2, 0
...
beq_cont.27904:
beq_cont.27902:
	lw	a0, -0(sp) #restore offset of index.2995.6764
	addi	a0, a0, -1
	flw	fa0, -12(sp) # restoref offset of diffuse.2996.6765
	flw	fa1, -4(sp) # restoref offset of hilight_scale.2997.6766
	lw	a1, -8(sp) #restore offset of dirvec.2998.6767
...
trace_ray.2999.6768:
	...
	addi	a5, a5, 0
	lw	a5, 0(a5)
	fsw	fa1, -0(sp) #savef offset of dist.3004.6773
	sw	a2, -4(sp) #save offset of pixel.3003.6772
	fsw	fa0, -8(sp) #savef offset of energy.3001.6770
	sw	a1, -12(sp) #save offset of dirvec.3002.6771
	sw	a3, -16(sp) #save offset of m_sids.5869.9638.12277
	sw	a0, -20(sp) #save offset of nref.3000.6769
	addi	a2, a1, 0
	addi	a0, a4, 0
	addi	a1, a5, 0
	sw	ra, -28(sp)
...
beq_cont.27914:
	...
	addi	a0, x0, -1
	lw	a1, -20(sp) #restore offset of nref.3000.6769
	slli	a2, a1, 2
	lw	a3, -16(sp) #restore offset of m_sids.5869.9638.12277
	add	a2, a3, a2
	sw	a0,0(a2) 
	addi	t6, x0, 0
...
be_else.27916:
	addi	a0, x0, 568
	lw	a1, -12(sp) #restore offset of dirvec.3002.6771
	addi	a2, a1, 0
	flw	fa0, 0(a2)
	addi	a2, a0, 0
	flw	fa1, 0(a2)
...
be_else.27918:
	fmul	fa1, fa0, fa0
	fmul	fa0, fa1, fa0
	flw	fa1, -8(sp) # restoref offset of energy.3001.6770
	fmul	fa0, fa0, fa1
	addi	a0, x0, 580
	addi	a0, a0, 0
	flw	fa1, 0(a0)
...
be_else.27915:
	...
	addi	a3, a3, -1
	slli	a3, a3, 2
	lw	a5, -12(sp) #restore offset of dirvec.3002.6771
	add	a3, a5, a3
	flw	fa2, 0(a3)
	fsgnjn	fs11, fa2, fa2
	feq	a3, fs11, fa2
...
beq_cont.27922:
	...
	addi	a5, a5, 8
	fsw	fa2, 0(a5) 
	sw	a2, -24(sp) #save offset of m_surface.6105.9874.12234
	fsw	fa0, -28(sp) #savef offset of diffuse.3922.7691
	sw	a1, -32(sp) #save offset of obj.3920.7689
	sw	a0, -36(sp) #save offset of obj_id.3919.7688
	addi	t6, x0, 1
...
beq_else.27945:
	...
	flw	fa6, 0(a4)
	flt	a4, fa5, fa6
	fsw	fa4, -40(sp) #savef offset of w4.4127.7896.12076
	sw	a3, -44(sp) #save offset of Ta969.4010.7779
	addi	t6, x0, 0
...
beq_cont.27950:
	...
	fcvtsw	fa1, t6
	fsub	fa0, fa0, fa1
	lw	a0, -44(sp) #restore offset of Ta969.4010.7779
	addi	a0, a0, 4
	flw	fa1, 0(a0)
	lw	a0, -32(sp) #restore offset of obj.3920.7689
	lw	a1, 20(a0)
	addi	a1, a1, 4
	flw	fa2, 0(a1)
	fsub	fa1, fa1, fa2
	...
	fsqrt	fa2, fa2
	fmul	fa1, fa1, fa2
	flw	fa2, -40(sp) # restoref offset of w4.4127.7896.12076
	fsgnjx	fa3, fa2, fa2
	luil	a1, l.24974
	srli	a1, a1, 1
	addil	a1, a1, l.24974
	flw	fa4, 0(a1)
	flt	a1, fa3, fa4
	fsw	fa0, -48(sp) #savef offset of w9.4129.7898.12083
	addi	t6, x0, 0
...
beq_cont.27952:
	...
	addil	a0, a0, l.24994
	flw	fa2, 0(a0)
	flw	fa3, -48(sp) # restoref offset of w9.4129.7898.12083
	fsub	fa2, fa2, fa3
	fmul	fa2, fa2, fa2
	fsub	fa1, fa1, fa2
	luil	a0, l.24994
...
beq_cont.27936:
	addi	a0, x0, 4
	lw	a1, -36(sp) #restore offset of obj_id.3919.7688
	mul	a0, a1, a0
	addi	a1, x0, 800
	addi	a1, a1, 0
	lw	a1, 0(a1)
	...
	add	a2, a3, a2
	sw	a0,0(a2) 
	lw	a0, -4(sp) #restore offset of pixel.3003.6772
	lw	a2, 4(a0)
	slli	a4, a1, 2
	add	a2, a2, a4
	lw	a2, 0(a2)
	...
	fsw	fa0, 0(a2) 
	lw	a2, 12(a0)
	lw	a4, -32(sp) #restore offset of obj.3920.7689
	lw	a5, 28(a4)
	addi	a5, a5, 0
	flw	fa0, 0(a5)
	luil	a5, l.24994
	...
	addil	a5, a5, l.25096
	flw	fa0, 0(a5)
	flw	fa1, -28(sp) # restoref offset of diffuse.3922.7691
	fmul	fa0, fa0, fa1
	addi	a5, a2, 0
	flw	fa2, 0(a5)
	fmul	fa2, fa2, fa0
...
beq_cont.27956:
	...
	addi	a6, a6, 0
	lw	a6, 0(a6)
	fsw	fa0, -52(sp) #savef offset of hilight_scale.3933.7702
	addi	a1, a6, 0
	addi	a0, a2, 0
	sw	ra, -60(sp)
	addi	sp, sp, -64
...
beq_else.27961:
	fmul	fa0, fa2, fa2
	fmul	fa0, fa0, fa0
	flw	fa2, -52(sp) # restoref offset of hilight_scale.3933.7702
	fmul	fa0, fa0, fa2
	addi	a0, x0, 860
	addi	a2, x0, 860
	addi	a2, a2, 0
...
beq_cont.27958:
	...
	lw	a0, 0(a0)
	addi	a0, a0, -1
	flw	fa0, -28(sp) # restoref offset of diffuse.3922.7691
	flw	fa1, -52(sp) # restoref offset of hilight_scale.3933.7702
	lw	a1, -12(sp) #restore offset of dirvec.3002.6771
	sw	ra, -60(sp)
	addi	sp, sp, -64
	...
	addi	x0, x0, 0
be_else.27963:
	lw	a0, -20(sp) #restore offset of nref.3000.6769
	addi	t6, x0, 4
...
bg_else.27965:
	...
	sw	a2,0(a1) 
bg_cont.27966:
	lw	a1, -24(sp) #restore offset of m_surface.6105.9874.12234
	addi	t6, x0, 2
	...
	addil	a1, a1, l.23642
	flw	fa0, 0(a1)
	lw	a1, -32(sp) #restore offset of obj.3920.7689
	lw	a1, 28(a1)
	addi	a1, a1, 0
	flw	fa2, 0(a1)
	fsub	fa0, fa0, fa2
	...
	addi	a1, a1, 0
	flw	fa1, 0(a1)
	flw	fa2, -0(sp) # restoref offset of dist.3004.6773
	fadd	fa1, fa2, fa1
	lw	a1, -12(sp) #restore offset of dirvec.3002.6771
	lw	a2, -4(sp) #restore offset of pixel.3003.6772
...
iter_trace_diffuse_rays.3008.6777:
	...
	fsgnjn	fs11, fa0, fa0
	flt	a1, fa0, fs11
	sw	a2, -0(sp) #save offset of org.3011.6780
	sw	a0, -4(sp) #save offset of dirvec_group.3009.6778
	sw	a3, -8(sp) #save offset of index.3012.6781
	addi	t6, x0, 0
	...
	addi	a5, a5, 0
	lw	a5, 0(a5)
	fsw	fa0, -12(sp) #savef offset of Td896.3881.7650
	sw	a1, -16(sp) #save offset of Tt894.3880.7649
	addi	a2, a1, 0
	addi	a0, a4, 0
	addi	a1, a5, 0
	sw	ra, -24(sp)
...
beq_else.27975:
	...
	addi	a0, a0, 304
	lw	a0, 0(a0)
	lw	a1, -16(sp) #restore offset of Tt894.3880.7649
	lw	a1, 0(a1)
	lw	a2, 4(a0)
	addi	t6, x0, 1
...
beq_cont.27978:
	...
	addi	a3, a3, 8
	fsw	fa0, 0(a3) 
	sw	a0, -20(sp) #save offset of obj.3888.7657.11544
	addi	t6, x0, 1
...
beq_else.28001:
	...
	flw	fa4, 0(a2)
	flt	a2, fa3, fa4
	fsw	fa2, -24(sp) #savef offset of w4.4127.7896.17341
	sw	a1, -28(sp) #save offset of Ta912.3909.7678.11547
	addi	t6, x0, 0
...
beq_cont.28006:
	...
	fcvtsw	fa1, t6
	fsub	fa0, fa0, fa1
	lw	a0, -28(sp) #restore offset of Ta912.3909.7678.11547
	addi	a0, a0, 4
	flw	fa1, 0(a0)
	lw	a0, -20(sp) #restore offset of obj.3888.7657.11544
	lw	a1, 20(a0)
	addi	a1, a1, 4
	flw	fa2, 0(a1)
	fsub	fa1, fa1, fa2
	...
	fsqrt	fa2, fa2
	fmul	fa1, fa1, fa2
	flw	fa2, -24(sp) # restoref offset of w4.4127.7896.17341
	fsgnjx	fa3, fa2, fa2
	luil	a1, l.24974
	srli	a1, a1, 1
	addil	a1, a1, l.24974
	flw	fa4, 0(a1)
	flt	a1, fa3, fa4
	fsw	fa0, -32(sp) #savef offset of w9.4129.7898.17348
	addi	t6, x0, 0
...
beq_cont.28008:
	...
	addil	a0, a0, l.24994
	flw	fa2, 0(a0)
	flw	fa3, -32(sp) # restoref offset of w9.4129.7898.17348
	fsub	fa2, fa2, fa3
	fmul	fa2, fa2, fa2
	fsub	fa1, fa1, fa2
	luil	a0, l.24994
...
beq_cont.28014:
	addi	a0, x0, 848
	flw	fa1, -12(sp) # restoref offset of Td896.3881.7650
	fmul	fa0, fa1, fa0
	lw	a1, -20(sp) #restore offset of obj.3888.7657.11544
	lw	a1, 28(a1)
	addi	a1, a1, 0
	flw	fa1, 0(a1)
	fmul	fa0, fa0, fa1
...
beq_else.27971:
	...
	addi	a5, a5, 0
	lw	a5, 0(a5)
	fsw	fa0, -36(sp) #savef offset of Td901.3876.7645
	sw	a1, -40(sp) #save offset of Tt899.3875.7644
	addi	a2, a1, 0
	addi	a0, a4, 0
	addi	a1, a5, 0
	sw	ra, -48(sp)
...
beq_else.28017:
	...
	addi	a0, a0, 304
	lw	a0, 0(a0)
	lw	a1, -40(sp) #restore offset of Tt899.3875.7644
	lw	a1, 0(a1)
	lw	a2, 4(a0)
	addi	t6, x0, 1
...
beq_cont.28020:
	...
	addi	a3, a3, 8
	fsw	fa0, 0(a3) 
	sw	a0, -44(sp) #save offset of obj.3888.7657.11515
	addi	t6, x0, 1
...
beq_else.28043:
	...
	flw	fa4, 0(a2)
	flt	a2, fa3, fa4
	fsw	fa2, -48(sp) #savef offset of w4.4127.7896.16838
	sw	a1, -52(sp) #save offset of Ta912.3909.7678.11518
	addi	t6, x0, 0
...
beq_cont.28048:
	...
	fcvtsw	fa1, t6
	fsub	fa0, fa0, fa1
	lw	a0, -52(sp) #restore offset of Ta912.3909.7678.11518
	addi	a0, a0, 4
	flw	fa1, 0(a0)
	lw	a0, -44(sp) #restore offset of obj.3888.7657.11515
	lw	a1, 20(a0)
	addi	a1, a1, 4
	flw	fa2, 0(a1)
	fsub	fa1, fa1, fa2
	...
	fsqrt	fa2, fa2
	fmul	fa1, fa1, fa2
	flw	fa2, -48(sp) # restoref offset of w4.4127.7896.16838
	fsgnjx	fa3, fa2, fa2
	luil	a1, l.24974
	srli	a1, a1, 1
	addil	a1, a1, l.24974
	flw	fa4, 0(a1)
	flt	a1, fa3, fa4
	fsw	fa0, -56(sp) #savef offset of w9.4129.7898.16845
	addi	t6, x0, 0
...
beq_cont.28050:
	...
	addil	a0, a0, l.24994
	flw	fa2, 0(a0)
	flw	fa3, -56(sp) # restoref offset of w9.4129.7898.16845
	fsub	fa2, fa2, fa3
	fmul	fa2, fa2, fa2
	fsub	fa1, fa1, fa2
	luil	a0, l.24994
...
beq_cont.28056:
	addi	a0, x0, 848
	flw	fa1, -36(sp) # restoref offset of Td901.3876.7645
	fmul	fa0, fa1, fa0
	lw	a1, -44(sp) #restore offset of obj.3888.7657.11515
	lw	a1, 28(a1)
	addi	a1, a1, 0
	flw	fa1, 0(a1)
	fmul	fa0, fa0, fa1
...
beq_cont.27972:
	addi	a1, x0, 824
	lw	a0, -8(sp) #restore offset of index.3012.6781
	addi	a3, a0, -2
	lw	a0, -4(sp) #restore offset of dirvec_group.3009.6778
	lw	a2, -0(sp) #restore offset of org.3011.6780
...
do_without_neighbors.3030.6799:
	...
	add	a2, a2, a3
	lw	a2, 0(a2)
	sw	a0, -0(sp) #save offset of pixel.3031.6800
	addi	t6, x0, 0
...
beq_else.28060:
	...
	add	a3, a3, a5
	lw	a3, 0(a3)
	sw	a4, -4(sp) #save offset of m_engy.5855.9624.16541
	sw	a1, -8(sp) #save offset of nref.3032.6801
	sw	a3, -12(sp) #save offset of Ta857.3832.7601.11188
	sw	a2, -16(sp) #save offset of Ti855.3830.7599.11186
	addi	t6, x0, 0
...
beq_else.28062:
	...
	lw	a6, 0(a6)
	addi	a6, a6, -1
	sw	a5, -20(sp) #save offset of Ta864.3860.7629.16513
	addi	a1, a6, 0
	addi	a0, a3, 0
	sw	ra, -28(sp)
	addi	sp, sp, -32
	...
	addi	a1, x0, 824
	addi	a3, x0, 118
	lw	a0, -20(sp) #restore offset of Ta864.3860.7629.16513
	lw	a2, -12(sp) #restore offset of Ta857.3832.7601.11188
	sw	ra, -28(sp)
	addi	sp, sp, -32
	...
	lw	ra, -28(sp)
beq_cont.28063:
	lw	a0, -16(sp) #restore offset of Ti855.3830.7599.11186
	addi	t6, x0, 1
...
beq_else.28064:
	...
	lw	a1, 0(a1)
	addi	a2, x0, 904
	lw	a3, -12(sp) #restore offset of Ta857.3832.7601.11188
	addi	a4, a3, 0
	flw	fa0, 0(a4)
	addi	a4, a2, 0
	fsw	fa0, 0(a4) 
	...
	lw	a2, 0(a2)
	addi	a2, a2, -1
	sw	a1, -24(sp) #save offset of Ta869.3855.7624.16507
	addi	a1, a2, 0
	addi	a0, a3, 0
	sw	ra, -32(sp)
	addi	sp, sp, -36
	...
	addi	a1, x0, 824
	addi	a3, x0, 118
	lw	a0, -24(sp) #restore offset of Ta869.3855.7624.16507
	lw	a2, -12(sp) #restore offset of Ta857.3832.7601.11188
	sw	ra, -32(sp)
	addi	sp, sp, -36
	jal	ra, iter_trace_diffuse_rays.3008.6777
...
beq_else.28066:
	...
	lw	a2, 0(a2)
	addi	a2, a2, -1
	sw	a1, -28(sp) #save offset of Ta874.3850.7619.16501
	addi	a1, a2, 0
	addi	a0, a3, 0
	sw	ra, -36(sp)
	addi	sp, sp, -40
	...
	addi	a1, x0, 824
	addi	a3, x0, 118
	lw	a0, -28(sp) #restore offset of Ta874.3850.7619.16501
	lw	a2, -12(sp) #restore offset of Ta857.3832.7601.11188
	sw	ra, -36(sp)
	addi	sp, sp, -40
	jal	ra, iter_trace_diffuse_rays.3008.6777
...
beq_else.28068:
	...
	lw	a2, 0(a2)
	addi	a2, a2, -1
	sw	a1, -32(sp) #save offset of Ta879.3845.7614.16495
	addi	a1, a2, 0
	addi	a0, a3, 0
	sw	ra, -40(sp)
	addi	sp, sp, -44
	...
	addi	a1, x0, 824
	addi	a3, x0, 118
	lw	a0, -32(sp) #restore offset of Ta879.3845.7614.16495
	lw	a2, -12(sp) #restore offset of Ta857.3832.7601.11188
	sw	ra, -40(sp)
	addi	sp, sp, -44
	jal	ra, iter_trace_diffuse_rays.3008.6777
...
beq_else.28070:
	...
	lw	a1, 0(a1)
	addi	a1, a1, -1
	sw	a0, -36(sp) #save offset of Ta884.3840.7609.16489
	addi	a0, a2, 0
	sw	ra, -44(sp)
	addi	sp, sp, -48
	jal	ra, setup_startp_constants.2910.6679
	...
	addi	a1, x0, 824
	addi	a3, x0, 118
	lw	a0, -36(sp) #restore offset of Ta884.3840.7609.16489
	lw	a2, -12(sp) #restore offset of Ta857.3832.7601.11188
	sw	ra, -44(sp)
	addi	sp, sp, -48
	jal	ra, iter_trace_diffuse_rays.3008.6777
...
beq_cont.28071:
	addi	a0, x0, 860
	lw	a1, -8(sp) #restore offset of nref.3032.6801
	slli	a2, a1, 2
	lw	a3, -4(sp) #restore offset of m_engy.5855.9624.16541
	add	a2, a3, a2
	lw	a2, 0(a2)
	addi	a3, x0, 848
	addi	a4, a0, 0
...
beq_cont.28061:
	addi	a1, a1, 1
	lw	a0, -0(sp) #restore offset of pixel.3031.6800
...
pretrace_diffuse_rays.3061.6830:
	...
	add	a2, a2, a3
	lw	a2, 0(a2)
	sw	a1, -0(sp) #save offset of nref.3063.6832
	addi	t6, x0, 0
...
beq_else.28091:
	...
	lw	a4, 0(a4)
	addi	a4, a4, -1
	sw	a0, -4(sp) #save offset of pixel.3062.6831
	sw	a3, -8(sp) #save offset of Ta743.3675.7444
	sw	a2, -12(sp) #save offset of Ta741.3673.7442
	addi	a1, a4, 0
	addi	a0, a3, 0
	sw	ra, -20(sp)
	addi	sp, sp, -24
	...
	addi	a1, x0, 824
	addi	a3, x0, 118
	lw	a0, -12(sp) #restore offset of Ta741.3673.7442
	lw	a2, -8(sp) #restore offset of Ta743.3675.7444
	sw	ra, -20(sp)
	addi	sp, sp, -24
	jal	ra, iter_trace_diffuse_rays.3008.6777
	addi	sp, sp, 24
	lw	ra, -20(sp)
	lw	a0, -4(sp) #restore offset of pixel.3062.6831
	lw	a1, 20(a0)
	lw	a2, -0(sp) #restore offset of nref.3063.6832
	slli	a3, a2, 2
	add	a1, a1, a3
	lw	a1, 0(a1)
	addi	a3, x0, 848
	...
	fsw	fa0, 8(a1) 
beq_cont.28092:
	lw	a1, -0(sp) #restore offset of nref.3063.6832
	addi	a1, a1, 1
...
beq_cont.28097:
	...
	addil	a6, a6, l.23583
	flw	fa4, 0(a6)
	fsw	fa2, -0(sp) #savef offset of lc2.3070.6839
	fsw	fa1, -4(sp) #savef offset of lc1.3069.6838
	fsw	fa0, -8(sp) #savef offset of lc0.3068.6837
	sw	a2, -12(sp) #save offset of group_id.3067.6836
	sw	a0, -16(sp) #save offset of line.3065.6834
	sw	a1, -20(sp) #save offset of x.3066.6835
	addi	a2, a5, 0
	addi	a1, a4, 0
	addi	a0, a3, 0
	fsgnj	fa1, fa4, fa4
	...
	addi	sp, sp, 32
	lw	ra, -28(sp)
	lw	a0, -20(sp) #restore offset of x.3066.6835
	slli	a1, a0, 2
	lw	a2, -16(sp) #restore offset of line.3065.6834
	add	a1, a2, a1
	lw	a1, 0(a1)
	lw	a1, 0(a1)
	addi	a3, x0, 860
	...
	lw	a1, 24(a1)
	addi	a1, a1, 0
	lw	a3, -12(sp) #restore offset of group_id.3067.6836
	sw	a3,0(a1) 
	slli	a1, a0, 2
	add	a1, a2, a1
	lw	a1, 0(a1)
	...
	lw	a0, -20(sp) #restore offset of x.3066.6835
	addi	a1, a0, -1
	lw	a0, -12(sp) #restore offset of group_id.3067.6836
	addi	a0, a0, 1
	addi	t6, x0, 5
...
bg_else.28098:
	addi	a2, a0 0
bg_cont.28099:
	flw	fa0, -8(sp) # restoref offset of lc0.3068.6837
	flw	fa1, -4(sp) # restoref offset of lc1.3069.6838
	flw	fa2, -0(sp) # restoref offset of lc2.3070.6839
	lw	a0, -16(sp) #restore offset of line.3065.6834
...
bg_cont.28106:
bg_cont.28104:
	sw	a4, -0(sp) #save offset of next.3080.6849
	sw	a3, -4(sp) #save offset of cur.3079.6848
	sw	a2, -8(sp) #save offset of prev.3078.6847
	sw	a1, -12(sp) #save offset of y.3077.6846
	sw	a0, -16(sp) #save offset of x.3076.6845
	sw	a5, -20(sp) #save offset of version.3081.6850
	addi	t6, x0, 0
...
beq_else.28111:
	...
	lw	ra, -28(sp)
beq_cont.28112:
	lw	a5, -20(sp) #restore offset of version.3081.6850
	addi	t6, x0, 3
...
bg_cont.28136:
	sw	a0, 0(s11)
beq_cont.28114:
	lw	a0, -16(sp) #restore offset of x.3076.6845
	addi	a0, a0, 1
	lw	a1, -12(sp) #restore offset of y.3077.6846
	lw	a2, -8(sp) #restore offset of prev.3078.6847
	lw	a3, -4(sp) #restore offset of cur.3079.6848
	lw	a4, -0(sp) #restore offset of next.3080.6849
...
bg_else.28139:
	...
	lw	a6, 0(a6)
	addi	a6, a6, -1
	sw	a4, -0(sp) #save offset of group_id.3087.6856
	sw	a5, -4(sp) #save offset of version.3088.6857
	sw	a3, -8(sp) #save offset of next.3086.6855
	sw	a2, -12(sp) #save offset of cur.3085.6854
	sw	a1, -16(sp) #save offset of prev.3084.6853
	sw	a0, -20(sp) #save offset of y.3083.6852
...
bg_cont.28142:
	addi	a0, x0, 0
	lw	a1, -20(sp) #restore offset of y.3083.6852
	lw	a2, -16(sp) #restore offset of prev.3084.6853
	lw	a3, -12(sp) #restore offset of cur.3085.6854
	lw	a4, -8(sp) #restore offset of next.3086.6855
	lw	a5, -4(sp) #restore offset of version.3088.6857
	sw	ra, -28(sp)
	addi	sp, sp, -32
	jal	ra, scan_pixel.3075.6844
	addi	sp, sp, 32
	lw	ra, -28(sp)
	lw	a0, -20(sp) #restore offset of y.3083.6852
	addi	a0, a0, 1
	lw	a1, -0(sp) #restore offset of group_id.3087.6856
	addi	a1, a1, 2
	addi	t6, x0, 5
...
bg_else.28143:
	addi	a4, a1 0
bg_cont.28144:
	lw	a1, -12(sp) #restore offset of cur.3085.6854
	lw	a2, -8(sp) #restore offset of next.3086.6855
	lw	a3, -16(sp) #restore offset of prev.3084.6853
	lw	a5, -4(sp) #restore offset of version.3088.6857
...
init_line_elements.3093.6862:
	...
	addil	a3, a3, l.23583
	flw	fa0, 0(a3)
	sw	a0, -0(sp) #save offset of line.3094.6863
	sw	a1, -4(sp) #save offset of n.3095.6864
	addi	t6, hp, 0
...
create_float_array_end.28146:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -8(sp) #save offset of m_rgb.3479.7248.10734
	addi	t6, hp, 0
...
create_array_end.28148:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -12(sp) #save offset of array.3500.7269.16147
	addi	t6, hp, 0
...
create_float_array_end.28149:
	addi	a0, t6, 0
	lw	a1, -12(sp) #restore offset of array.3500.7269.16147
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_array_end.28153:
	...
	addi	a1, x0, 5
	addi	a2, x0, 0
	sw	a0, -16(sp) #save offset of m_sids.3481.7250.10739
	addi	t6, hp, 0
...
create_array_end.28154:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -20(sp) #save offset of m_cdif.3482.7251.10742
	addi	t6, hp, 0
...
create_array_end.28156:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -24(sp) #save offset of array.3500.7269.16122
	addi	t6, hp, 0
...
create_float_array_end.28157:
	addi	a0, t6, 0
	lw	a1, -24(sp) #restore offset of array.3500.7269.16122
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_array_end.28162:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -28(sp) #save offset of array.3500.7269.16097
	addi	t6, hp, 0
...
create_float_array_end.28163:
	addi	a0, t6, 0
	lw	a1, -28(sp) #restore offset of array.3500.7269.16097
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_array_end.28167:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -32(sp) #save offset of m_gid.3485.7254.10749
	addi	t6, hp, 0
...
create_array_end.28169:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -36(sp) #save offset of array.3500.7269.16072
	addi	t6, hp, 0
...
create_float_array_end.28170:
	addi	a0, t6, 0
	lw	a1, -36(sp) #restore offset of array.3500.7269.16072
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_float_array_end.28173:
	...
	addi	hp, hp, 32
	sw	a1,28(a0) 
	lw	a1, -32(sp) #restore offset of m_gid.3485.7254.10749
	sw	a1,24(a0) 
	lw	a1, -28(sp) #restore offset of array.3500.7269.16097
	sw	a1,20(a0) 
	lw	a1, -24(sp) #restore offset of array.3500.7269.16122
	sw	a1,16(a0) 
	lw	a1, -20(sp) #restore offset of m_cdif.3482.7251.10742
	sw	a1,12(a0) 
	lw	a1, -16(sp) #restore offset of m_sids.3481.7250.10739
	sw	a1,8(a0) 
	lw	a1, -12(sp) #restore offset of array.3500.7269.16147
	sw	a1,4(a0) 
	lw	a1, -8(sp) #restore offset of m_rgb.3479.7248.10734
	sw	a1,0(a0) 
	lw	a1, -4(sp) #restore offset of n.3095.6864
	slli	a2, a1, 2
	lw	a3, -0(sp) #restore offset of line.3094.6863
	add	a2, a3, a2
	sw	a0,0(a2) 
	addi	a1, a1, -1
	addi	a0, a3, 0
...
bg_else.28174:
	...
	flw	fa1, 0(a3)
	fdiv	fa1, fa1, fa0
	sw	a2, -0(sp) #save offset of index.3110.6879
	sw	a1, -4(sp) #save offset of group_id.3109.6878
	fsw	fa3, -8(sp) #savef offset of ry.3108.6877
	sw	a0, -12(sp) #save offset of icount.3104.6873
	fsw	fa0, -16(sp) #savef offset of l.3451.7220.10662
	fsw	fa2, -20(sp) #savef offset of rx.3107.6876
	fsgnj	fa0, fa1, fa1
	sw	ra, -28(sp)
	addi	sp, sp, -32
	jal	ra, min_caml_atan
	addi	sp, sp, 32
	lw	ra, -28(sp)
	flw	fa1, -20(sp) # restoref offset of rx.3107.6876
	fmul	fa0, fa0, fa1
	fsw	fa0, -24(sp) #savef offset of Td574.3455.7224.10666
	sw	ra, -32(sp)
	addi	sp, sp, -36
	jal	ra, min_caml_sin
	addi	sp, sp, 36
	lw	ra, -32(sp)
	flw	fa1, -24(sp) # restoref offset of Td574.3455.7224.10666
	fsw	fa0, -28(sp) #savef offset of Td575.3460.7229.15966
	fsgnj	fa0, fa1, fa1
	sw	ra, -36(sp)
	addi	sp, sp, -40
	jal	ra, min_caml_cos
	addi	sp, sp, 40
	lw	ra, -36(sp)
	flw	fa1, -28(sp) # restoref offset of Td575.3460.7229.15966
	fdiv	fa0, fa1, fa0
	flw	fa1, -16(sp) # restoref offset of l.3451.7220.10662
	fmul	fa0, fa0, fa1
	lw	a0, -12(sp) #restore offset of icount.3104.6873
	addi	a0, a0, 1
	fmul	fa1, fa0, fa0
	luil	a1, l.25230
	srli	a1, a1, 1
	...
	flw	fa2, 0(a1)
	fdiv	fa2, fa2, fa1
	fsw	fa0, -32(sp) #savef offset of x2.3399.7168
	sw	a0, -36(sp) #save offset of Ti568.3400.7169
	fsw	fa1, -40(sp) #savef offset of l.3451.7220.10653
	fsgnj	fa0, fa2, fa2
	sw	ra, -48(sp)
	addi	sp, sp, -52
	jal	ra, min_caml_atan
	addi	sp, sp, 52
	lw	ra, -48(sp)
	flw	fa1, -8(sp) # restoref offset of ry.3108.6877
	fmul	fa0, fa0, fa1
	fsw	fa0, -44(sp) #savef offset of Td574.3455.7224.10657
	sw	ra, -52(sp)
	addi	sp, sp, -56
	jal	ra, min_caml_sin
	addi	sp, sp, 56
	lw	ra, -52(sp)
	flw	fa1, -44(sp) # restoref offset of Td574.3455.7224.10657
	fsw	fa0, -48(sp) #savef offset of Td575.3460.7229.15964
	fsgnj	fa0, fa1, fa1
	sw	ra, -56(sp)
	addi	sp, sp, -60
	jal	ra, min_caml_cos
	addi	sp, sp, 60
	lw	ra, -56(sp)
	flw	fa1, -48(sp) # restoref offset of Td575.3460.7229.15964
	fdiv	fa0, fa1, fa0
	flw	fa1, -40(sp) # restoref offset of l.3451.7220.10653
	fmul	fa1, fa0, fa1
	flw	fa0, -32(sp) # restoref offset of x2.3399.7168
	flw	fa2, -20(sp) # restoref offset of rx.3107.6876
	flw	fa3, -8(sp) # restoref offset of ry.3108.6877
	lw	a0, -36(sp) #restore offset of Ti568.3400.7169
	lw	a1, -4(sp) #restore offset of group_id.3109.6878
	lw	a2, -0(sp) #restore offset of index.3110.6879
...
calc_dirvecs.3111.6880:
	...
	addil	a4, a4, l.23583
	flw	fa3, 0(a4)
	fsw	fa0, -0(sp) #savef offset of ry.3113.6882
	sw	a1, -4(sp) #save offset of group_id.3114.6883
	sw	a2, -8(sp) #save offset of index.3115.6884
	sw	a0, -12(sp) #save offset of col.3112.6881
	addi	a0, a3, 0
	fsgnj	fs11, fa3, fa3
	fsgnj	fa3, fa0, fa0
	fsgnj	fa0, fa1, fa1
	...
	addi	sp, sp, 24
	lw	ra, -20(sp)
	lw	a0, -12(sp) #restore offset of col.3112.6881
	fcvtsw	fa0, a0
	luil	a1, l.26341
	srli	a1, a1, 1
	addil	a1, a1, l.26341
	...
	addil	a2, a2, l.23583
	flw	fa1, 0(a2)
	lw	a2, -8(sp) #restore offset of index.3115.6884
	addi	a3, a2, 2
	flw	fa3, -0(sp) # restoref offset of ry.3113.6882
	lw	a4, -4(sp) #restore offset of group_id.3114.6883
	addi	a2, a3, 0
	addi	a0, a1, 0
	addi	a1, a4, 0
	sw	ra, -20(sp)
	...
	lw	a0, -12(sp) #restore offset of col.3112.6881
	addi	a0, a0, -1
	lw	a1, -4(sp) #restore offset of group_id.3114.6883
	addi	a1, a1, 1
	addi	t6, x0, 5
...
bg_else.28177:
bg_cont.28178:
	flw	fa0, -0(sp) # restoref offset of ry.3113.6882
	lw	a2, -8(sp) #restore offset of index.3115.6884
...
calc_dirvec_rows.3116.6885:
	...
	fsub	fa0, fa0, fa1
	addi	a3, x0, 4
	sw	a2, -0(sp) #save offset of index.3119.6888
	sw	a1, -4(sp) #save offset of group_id.3118.6887
	sw	a0, -8(sp) #save offset of row.3117.6886
	addi	a0, a3, 0
	sw	ra, -16(sp)
	addi	sp, sp, -20
	...
	addi	sp, sp, 20
	lw	ra, -16(sp)
	lw	a0, -8(sp) #restore offset of row.3117.6886
	addi	a0, a0, -1
	lw	a1, -4(sp) #restore offset of group_id.3118.6887
	addi	a1, a1, 2
	addi	t6, x0, 5
...
bg_else.28181:
bg_cont.28182:
	lw	a2, -0(sp) #restore offset of index.3119.6888
	addi	a2, a2, 4
...
create_dirvec_elements.3122.6891:
	...
	addil	a3, a3, l.23583
	flw	fa0, 0(a3)
	sw	a0, -0(sp) #save offset of d.3123.6892
	sw	a1, -4(sp) #save offset of index.3124.6893
	addi	t6, hp, 0
...
create_float_array_end.28185:
	...
	addi	a1, a1, 0
	lw	a1, 0(a1)
	sw	a0, -8(sp) #save offset of v3.3352.7121.10639
	addi	t6, hp, 0
...
create_array_end.28186:
	...
	addi	hp, hp, 8
	sw	a0,4(a1) 
	lw	a0, -8(sp) #restore offset of v3.3352.7121.10639
	sw	a0,0(a1) 
	addi	a0, a1 0
	lw	a1, -4(sp) #restore offset of index.3124.6893
	slli	a2, a1, 2
	lw	a3, -0(sp) #restore offset of d.3123.6892
	add	a2, a3, a2
	sw	a0,0(a2) 
	addi	a1, a1, -1
	addi	a0, a3, 0
...
create_dirvecs.3125.6894:
	...
	addil	a3, a3, l.23583
	flw	fa0, 0(a3)
	sw	a0, -0(sp) #save offset of index.3126.6895
	sw	a1, -4(sp) #save offset of Ti476.3343.7112
	addi	t6, hp, 0
...
create_float_array_end.28189:
	...
	addi	a1, a1, 0
	lw	a1, 0(a1)
	sw	a0, -8(sp) #save offset of v3.3352.7121.10632
	addi	t6, hp, 0
...
create_array_end.28190:
	...
	addi	hp, hp, 8
	sw	a0,4(a1) 
	lw	a0, -8(sp) #restore offset of v3.3352.7121.10632
	sw	a0,0(a1) 
	addi	a0, a1 0
	lw	a1, -4(sp) #restore offset of Ti476.3343.7112
	addi	t6, hp, 0
...
create_array_end.28191:
	addi	a0, t6, 0
	lw	a1, -0(sp) #restore offset of index.3126.6895
	slli	a2, a1, 2
	addi	a2, a2, 964
	sw	a0,0(a2) 
	slli	a0, a1, 2
	...
	addi	sp, sp, 20
	lw	ra, -16(sp)
	lw	a0, -0(sp) #restore offset of index.3126.6895
	addi	a0, a0, -1
...
init_dirvec_constants.3127.6896:
	...
	lw	a3, 0(a3)
	addi	a3, a3, -1
	sw	a0, -0(sp) #save offset of vecset.3128.6897
	sw	a1, -4(sp) #save offset of index.3129.6898
	addi	a1, a3, 0
	addi	a0, a2, 0
	sw	ra, -12(sp)
	addi	sp, sp, -16
	...
	addi	sp, sp, 16
	lw	ra, -12(sp)
	lw	a0, -4(sp) #restore offset of index.3129.6898
	addi	a1, a0, -1
	lw	a0, -0(sp) #restore offset of vecset.3128.6897
...
init_vecset_constants.3130.6899:
	...
	lw	a1, 0(a1)
	addi	a2, x0, 119
	sw	a0, -0(sp) #save offset of index.3131.6900
	addi	a0, a1, 0
	addi	a1, a2, 0
	sw	ra, -8(sp)
	addi	sp, sp, -12
	...
	addi	sp, sp, 12
	lw	ra, -8(sp)
	lw	a0, -0(sp) #restore offset of index.3131.6900
	addi	a0, a0, -1
...
create_float_array_end.28203:
	...
	addi	a1, x0, 1
	addi	a2, x0, -1
	sw	a0, -0(sp) #save offset of Ti266.6383.10152
	addi	t6, hp, 0
...
create_array_end.28204:
	addi	a0, t6, 0
	lw	a1, -0(sp) #restore offset of Ti266.6383.10152
	addi	t6, hp, 0
...
create_array_end.28205:
	...
	addi	a1, a1, 0
	lw	a1, 0(a1)
	sw	a0, -4(sp) #save offset of Ti271.6377.10146
	addi	t6, hp, 0
...
create_array_end.28206:
	addi	a0, t6, 0
	lw	a1, -4(sp) #restore offset of Ti271.6377.10146
	addi	t6, hp, 0
...
create_float_array_end.28226:
	addi	a0, t6, 0
	addi	a1, x0, 0
	sw	a0, -8(sp) #save offset of dummyf.6332.10101
	addi	t6, hp, 0
...
create_array_end.28227:
	...
	addi	hp, hp, 8
	sw	a0,4(a2) 
	lw	a0, -8(sp) #restore offset of dummyf.6332.10101
	sw	a0,0(a2) 
	addi	a0, a2 0
	addi	t6, hp, 0
...
create_float_array_end.28230:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -12(sp) #save offset of dummyf2.6324.10093
	addi	t6, hp, 0
...
create_float_array_end.28231:
	addi	a0, t6, 0
	addi	a0, x0, 60
	lw	a1, -12(sp) #restore offset of dummyf2.6324.10093
	addi	t6, hp, 0
...
create_float_array_end.28233:
	addi	a0, t6, 0
	addi	a1, x0, 0
	sw	a0, -16(sp) #save offset of dummyf3.6314.10083
	addi	t6, hp, 0
...
create_array_end.28234:
	...
	addi	hp, hp, 8
	sw	a0,4(a1) 
	lw	a0, -16(sp) #restore offset of dummyf3.6314.10083
	sw	a0,0(a1) 
	addi	a0, a1 0
	addi	a1, x0, 180
	addi	a2, x0, 0
...
create_array_end.28236:
	...
	addil	a3, a3, l.23583
	flw	fa0, 0(a3)
	sw	a2, -20(sp) #save offset of Ti335.3156.6925
	sw	a0, -24(sp) #save offset of Ti579.3468.7237.15749
	addi	t6, hp, 0
...
create_float_array_end.28237:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -28(sp) #save offset of m_rgb.3479.7248.10714.15752
	addi	t6, hp, 0
...
create_array_end.28239:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -32(sp) #save offset of array.3500.7269.22082
	addi	t6, hp, 0
...
create_float_array_end.28240:
	addi	a0, t6, 0
	lw	a1, -32(sp) #restore offset of array.3500.7269.22082
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_array_end.28244:
	...
	addi	a1, x0, 5
	addi	a2, x0, 0
	sw	a0, -36(sp) #save offset of m_sids.3481.7250.10719.15757
	addi	t6, hp, 0
...
create_array_end.28245:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -40(sp) #save offset of m_cdif.3482.7251.10722.15760
	addi	t6, hp, 0
...
create_array_end.28247:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -44(sp) #save offset of array.3500.7269.22057
	addi	t6, hp, 0
...
create_float_array_end.28248:
	addi	a0, t6, 0
	lw	a1, -44(sp) #restore offset of array.3500.7269.22057
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_array_end.28253:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -48(sp) #save offset of array.3500.7269.22032
	addi	t6, hp, 0
...
create_float_array_end.28254:
	addi	a0, t6, 0
	lw	a1, -48(sp) #restore offset of array.3500.7269.22032
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_array_end.28258:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -52(sp) #save offset of m_gid.3485.7254.10729.15767
	addi	t6, hp, 0
...
create_array_end.28260:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -56(sp) #save offset of array.3500.7269.22007
	addi	t6, hp, 0
...
create_float_array_end.28261:
	addi	a0, t6, 0
	lw	a1, -56(sp) #restore offset of array.3500.7269.22007
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_float_array_end.28264:
	...
	addi	hp, hp, 32
	sw	a1,28(a0) 
	lw	a1, -52(sp) #restore offset of m_gid.3485.7254.10729.15767
	sw	a1,24(a0) 
	lw	a1, -48(sp) #restore offset of array.3500.7269.22032
	sw	a1,20(a0) 
	lw	a1, -44(sp) #restore offset of array.3500.7269.22057
	sw	a1,16(a0) 
	lw	a1, -40(sp) #restore offset of m_cdif.3482.7251.10722.15760
	sw	a1,12(a0) 
	lw	a1, -36(sp) #restore offset of m_sids.3481.7250.10719.15757
	sw	a1,8(a0) 
	lw	a1, -32(sp) #restore offset of array.3500.7269.22082
	sw	a1,4(a0) 
	lw	a1, -28(sp) #restore offset of m_rgb.3479.7248.10714.15752
	sw	a1,0(a0) 
	lw	a1, -24(sp) #restore offset of Ti579.3468.7237.15749
	addi	t6, hp, 0
...
create_array_end.28265:
	...
	addil	a3, a3, l.23583
	flw	fa0, 0(a3)
	sw	a0, -60(sp) #save offset of prev.3162.6931.10200
	sw	a1, -64(sp) #save offset of Ti579.3468.7237.15719
	addi	t6, hp, 0
...
create_float_array_end.28266:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -68(sp) #save offset of m_rgb.3479.7248.10714.15722
	addi	t6, hp, 0
...
create_array_end.28268:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -72(sp) #save offset of array.3500.7269.21982
	addi	t6, hp, 0
...
create_float_array_end.28269:
	addi	a0, t6, 0
	lw	a1, -72(sp) #restore offset of array.3500.7269.21982
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_array_end.28273:
	...
	addi	a1, x0, 5
	addi	a2, x0, 0
	sw	a0, -76(sp) #save offset of m_sids.3481.7250.10719.15727
	addi	t6, hp, 0
...
create_array_end.28274:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -80(sp) #save offset of m_cdif.3482.7251.10722.15730
	addi	t6, hp, 0
...
create_array_end.28276:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -84(sp) #save offset of array.3500.7269.21957
	addi	t6, hp, 0
...
create_float_array_end.28277:
	addi	a0, t6, 0
	lw	a1, -84(sp) #restore offset of array.3500.7269.21957
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_array_end.28282:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -88(sp) #save offset of array.3500.7269.21932
	addi	t6, hp, 0
...
create_float_array_end.28283:
	addi	a0, t6, 0
	lw	a1, -88(sp) #restore offset of array.3500.7269.21932
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_array_end.28287:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -92(sp) #save offset of m_gid.3485.7254.10729.15737
	addi	t6, hp, 0
...
create_array_end.28289:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -96(sp) #save offset of array.3500.7269.21907
	addi	t6, hp, 0
...
create_float_array_end.28290:
	addi	a0, t6, 0
	lw	a1, -96(sp) #restore offset of array.3500.7269.21907
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_float_array_end.28293:
	...
	addi	hp, hp, 32
	sw	a1,28(a0) 
	lw	a1, -92(sp) #restore offset of m_gid.3485.7254.10729.15737
	sw	a1,24(a0) 
	lw	a1, -88(sp) #restore offset of array.3500.7269.21932
	sw	a1,20(a0) 
	lw	a1, -84(sp) #restore offset of array.3500.7269.21957
	sw	a1,16(a0) 
	lw	a1, -80(sp) #restore offset of m_cdif.3482.7251.10722.15730
	sw	a1,12(a0) 
	lw	a1, -76(sp) #restore offset of m_sids.3481.7250.10719.15727
	sw	a1,8(a0) 
	lw	a1, -72(sp) #restore offset of array.3500.7269.21982
	sw	a1,4(a0) 
	lw	a1, -68(sp) #restore offset of m_rgb.3479.7248.10714.15722
	sw	a1,0(a0) 
	lw	a1, -64(sp) #restore offset of Ti579.3468.7237.15719
	addi	t6, hp, 0
...
create_array_end.28294:
	...
	addil	a3, a3, l.23583
	flw	fa0, 0(a3)
	sw	a0, -100(sp) #save offset of cur.3163.6932.10202
	sw	a1, -104(sp) #save offset of Ti579.3468.7237.15689
	addi	t6, hp, 0
...
create_float_array_end.28295:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -108(sp) #save offset of m_rgb.3479.7248.10714.15692
	addi	t6, hp, 0
...
create_array_end.28297:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -112(sp) #save offset of array.3500.7269.21882
	addi	t6, hp, 0
...
create_float_array_end.28298:
	addi	a0, t6, 0
	lw	a1, -112(sp) #restore offset of array.3500.7269.21882
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_array_end.28302:
	...
	addi	a1, x0, 5
	addi	a2, x0, 0
	sw	a0, -116(sp) #save offset of m_sids.3481.7250.10719.15697
	addi	t6, hp, 0
...
create_array_end.28303:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -120(sp) #save offset of m_cdif.3482.7251.10722.15700
	addi	t6, hp, 0
...
create_array_end.28305:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -124(sp) #save offset of array.3500.7269.21857
	addi	t6, hp, 0
...
create_float_array_end.28306:
	addi	a0, t6, 0
	lw	a1, -124(sp) #restore offset of array.3500.7269.21857
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_array_end.28311:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -128(sp) #save offset of array.3500.7269.21832
	addi	t6, hp, 0
...
create_float_array_end.28312:
	addi	a0, t6, 0
	lw	a1, -128(sp) #restore offset of array.3500.7269.21832
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_array_end.28316:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -132(sp) #save offset of m_gid.3485.7254.10729.15707
	addi	t6, hp, 0
...
create_array_end.28318:
	...
	addil	a2, a2, l.23583
	flw	fa0, 0(a2)
	sw	a0, -136(sp) #save offset of array.3500.7269.21807
	addi	t6, hp, 0
...
create_float_array_end.28319:
	addi	a0, t6, 0
	lw	a1, -136(sp) #restore offset of array.3500.7269.21807
	addi	a2, a1, 4
	sw	a0,0(a2) 
	addi	a0, x0, 3
	luil	a2, l.23583
...
create_float_array_end.28322:
	...
	addi	hp, hp, 32
	sw	a1,28(a0) 
	lw	a1, -132(sp) #restore offset of m_gid.3485.7254.10729.15707
	sw	a1,24(a0) 
	lw	a1, -128(sp) #restore offset of array.3500.7269.21832
	sw	a1,20(a0) 
	lw	a1, -124(sp) #restore offset of array.3500.7269.21857
	sw	a1,16(a0) 
	lw	a1, -120(sp) #restore offset of m_cdif.3482.7251.10722.15700
	sw	a1,12(a0) 
	lw	a1, -116(sp) #restore offset of m_sids.3481.7250.10719.15697
	sw	a1,8(a0) 
	lw	a1, -112(sp) #restore offset of array.3500.7269.21882
	sw	a1,4(a0) 
	lw	a1, -108(sp) #restore offset of m_rgb.3479.7248.10714.15692
	sw	a1,0(a0) 
	lw	a1, -104(sp) #restore offset of Ti579.3468.7237.15689
	addi	t6, hp, 0
...
create_array_end.28323:
	...
	flw	fa1, 0(a1)
	fmul	fa0, fa0, fa1
	sw	a0, -140(sp) #save offset of next.3164.6933.10204
	fsw	fa0, -144(sp) #savef offset of v1.5710.9479.14960.15570
	sw	ra, -152(sp)
	addi	sp, sp, -156
	jal	ra, min_caml_cos
	addi	sp, sp, 156
	lw	ra, -152(sp)
	flw	fa1, -144(sp) # restoref offset of v1.5710.9479.14960.15570
	fsw	fa0, -148(sp) #savef offset of cos_v1.5711.9480.14961.15571
	fsgnj	fa0, fa1, fa1
	sw	ra, -156(sp)
	addi	sp, sp, -160
	jal	ra, min_caml_sin
	...
	flw	fa2, 0(a0)
	fmul	fa1, fa1, fa2
	fsw	fa0, -152(sp) #savef offset of sin_v1.5712.9481.14962.15572
	fsw	fa1, -156(sp) #savef offset of v2.5713.9482.14965.15575
	fsgnj	fa0, fa1, fa1
	sw	ra, -164(sp)
	addi	sp, sp, -168
	jal	ra, min_caml_cos
	addi	sp, sp, 168
	lw	ra, -164(sp)
	flw	fa1, -156(sp) # restoref offset of v2.5713.9482.14965.15575
	fsw	fa0, -160(sp) #savef offset of cos_v2.5714.9483.14966.15576
	fsgnj	fa0, fa1, fa1
	sw	ra, -168(sp)
	addi	sp, sp, -172
	jal	ra, min_caml_sin
	...
	lw	ra, -168(sp)
	addi	a0, x0, 940
	flw	fa1, -148(sp) # restoref offset of cos_v1.5711.9480.14961.15571
	fmul	fa2, fa1, fa0
	luil	a1, l.26643
	srli	a1, a1, 1
	addil	a1, a1, l.26643
	...
	addil	a1, a1, l.26647
	flw	fa2, 0(a1)
	flw	fa3, -152(sp) # restoref offset of sin_v1.5712.9481.14962.15572
	fmul	fa2, fa3, fa2
	addi	a0, a0, 4
	fsw	fa2, 0(a0) 
	addi	a0, x0, 940
	flw	fa2, -160(sp) # restoref offset of cos_v2.5714.9483.14966.15576
	fmul	fa4, fa1, fa2
	luil	a1, l.26643
	srli	a1, a1, 1
	addil	a1, a1, l.26643
	...
	flw	fa1, 0(a0)
	fmul	fa0, fa0, fa1
	fsw	fa0, -164(sp) #savef offset of l1.5680.9449.14919.15654
	sw	ra, -172(sp)
	addi	sp, sp, -176
	jal	ra, min_caml_sin
	addi	sp, sp, 176
	...
	flw	fa1, 0(a0)
	fmul	fa0, fa0, fa1
	flw	fa1, -164(sp) # restoref offset of l1.5680.9449.14919.15654
	fsw	fa0, -168(sp) #savef offset of l2.5683.9452.14927.15662
	fsgnj	fa0, fa1, fa1
	sw	ra, -176(sp)
	addi	sp, sp, -180
	jal	ra, min_caml_cos
	addi	sp, sp, 180
	lw	ra, -176(sp)
	flw	fa1, -168(sp) # restoref offset of l2.5683.9452.14927.15662
	fsw	fa0, -172(sp) #savef offset of cl1.5684.9453.14928.15663
	fsgnj	fa0, fa1, fa1
	sw	ra, -180(sp)
	addi	sp, sp, -184
	jal	ra, min_caml_sin
	...
	lw	ra, -180(sp)
	addi	a0, x0, 568
	flw	fa1, -172(sp) # restoref offset of cl1.5684.9453.14928.15663
	fmul	fa0, fa1, fa0
	addi	a0, a0, 0
	fsw	fa0, 0(a0) 
	flw	fa0, -168(sp) # restoref offset of l2.5683.9452.14927.15662
	sw	ra, -180(sp)
	addi	sp, sp, -184
	jal	ra, min_caml_cos
	addi	sp, sp, 184
	...
	addi	a0, x0, 792
	addi	a1, x0, 0
	sw	a0, -176(sp) #save offset of Ta2152.5390.9159.15683
	addi	a0, a1, 0
	sw	ra, -184(sp)
	addi	sp, sp, -188
	jal	ra, read_or_network.2806.6575
	addi	sp, sp, 188
	lw	ra, -184(sp)
	lw	a1, -176(sp) #restore offset of Ta2152.5390.9159.15683
	addi	a1, a1, 0
	sw	a0,0(a1) 
	addi	a0, x0, 80
	sw	a0, 0(s11)
...
beq_else.28328:
	...
	addil	a4, a4, l.23583
	flw	fa5, 0(a4)
	fsw	fa1, -180(sp) #savef offset of n0.3264.7033.10422.15471
	sw	a0, -184(sp) #save offset of sid.3261.7030.10412.15461
	sw	a2, -188(sp) #save offset of nr.3262.7031.10415.15464
	sw	a1, -192(sp) #save offset of Ti433.3288.7057.10432.15481
	fsw	fa0, -196(sp) #savef offset of br.3263.7032.10418.15467
	fsw	fa3, -200(sp) #savef offset of n2.3266.7035.10430.15479
	fsw	fa2, -204(sp) #savef offset of n1.3265.7034.10426.15475
	fsw	fa4, -208(sp) #savef offset of Td436.3289.7058.10435.15484
	addi	t6, hp, 0
...
create_float_array_end.28332:
	...
	addi	a1, a1, 0
	lw	a1, 0(a1)
	sw	a0, -212(sp) #save offset of v3.3352.7121.10620.21767
	addi	t6, hp, 0
...
create_array_end.28333:
	...
	addi	hp, hp, 8
	sw	a0,4(a1) 
	lw	a0, -212(sp) #restore offset of v3.3352.7121.10620.21767
	sw	a0,0(a1) 
	addi	a2, a0, 0
	flw	fa0, -208(sp) # restoref offset of Td436.3289.7058.10435.15484
	fsw	fa0, 0(a2) 
	addi	a2, a0, 4
	flw	fa0, -204(sp) # restoref offset of n1.3265.7034.10426.15475
	fsw	fa0, 0(a2) 
	addi	a0, a0, 8
	flw	fa1, -200(sp) # restoref offset of n2.3266.7035.10430.15479
	fsw	fa1, 0(a0) 
	addi	a0, x0, 256
	addi	a0, a0, 0
	lw	a0, 0(a0)
	addi	a0, a0, -1
	sw	a1, -216(sp) #save offset of dvec.3307.7076.21772
	addi	t6, a1, 0
	addi	a1, a0, 0
	addi	a0, t6, 0
	sw	ra, -224(sp)
	...
	addi	a0, hp 0
	addi	hp, hp, 12
	flw	fa0, -196(sp) # restoref offset of br.3263.7032.10418.15467
	fsw	fa0, 8(a0) 
	lw	a1, -216(sp) #restore offset of dvec.3307.7076.21772
	sw	a1,4(a0) 
	lw	a1, -192(sp) #restore offset of Ti433.3288.7057.10432.15481
	sw	a1,0(a0) 
	lw	a1, -188(sp) #restore offset of nr.3262.7031.10415.15464
	slli	a2, a1, 2
	addi	a2, a2, 1264
	sw	a0,0(a2) 
	addi	a0, a1, 1
	lw	a2, -184(sp) #restore offset of sid.3261.7030.10412.15461
	addi	a3, a2, 2
	addi	a4, x0, 568
	addi	a4, a4, 4
	flw	fa1, 0(a4)
	...
	addil	a5, a5, l.23583
	flw	fa2, 0(a5)
	sw	a0, -220(sp) #save offset of Ti438.3281.7050.10438.15487
	sw	a3, -224(sp) #save offset of Ti440.3282.7051.10440.15489
	fsw	fa1, -228(sp) #savef offset of Td443.3283.7052.10443.15492
	addi	t6, hp, 0
...
create_float_array_end.28334:
	...
	addi	a1, a1, 0
	lw	a1, 0(a1)
	sw	a0, -232(sp) #save offset of v3.3352.7121.10620.21745
	addi	t6, hp, 0
...
create_array_end.28335:
	...
	addi	hp, hp, 8
	sw	a0,4(a1) 
	lw	a0, -232(sp) #restore offset of v3.3352.7121.10620.21745
	sw	a0,0(a1) 
	addi	a2, a0, 0
	flw	fa0, -180(sp) # restoref offset of n0.3264.7033.10422.15471
	fsw	fa0, 0(a2) 
	addi	a2, a0, 4
	flw	fa1, -228(sp) # restoref offset of Td443.3283.7052.10443.15492
	fsw	fa1, 0(a2) 
	addi	a0, a0, 8
	flw	fa1, -200(sp) # restoref offset of n2.3266.7035.10430.15479
	fsw	fa1, 0(a0) 
	...
	lw	a0, 0(a0)
	addi	a0, a0, -1
	sw	a1, -236(sp) #save offset of dvec.3307.7076.21750
	addi	t6, a1, 0
	addi	a1, a0, 0
	addi	a0, t6, 0
	sw	ra, -244(sp)
	...
	flw	fa0, -196(sp) # restoref offset of br.3263.7032.10418.15467
	fsw	fa0, 8(a0) 
	lw	a1, -236(sp) #restore offset of dvec.3307.7076.21750
	sw	a1,4(a0) 
	lw	a1, -224(sp) #restore offset of Ti440.3282.7051.10440.15489
	sw	a1,0(a0) 
	lw	a1, -220(sp) #restore offset of Ti438.3281.7050.10438.15487
	slli	a1, a1, 2
	addi	a1, a1, 1264
	sw	a0,0(a1) 
	lw	a0, -188(sp) #restore offset of nr.3262.7031.10415.15464
	addi	a1, a0, 2
	lw	a2, -184(sp) #restore offset of sid.3261.7030.10412.15461
	addi	a2, a2, 3
	addi	a3, x0, 568
	...
	addil	a4, a4, l.23583
	flw	fa2, 0(a4)
	sw	a1, -240(sp) #save offset of Ti445.3274.7043.10446.15495
	sw	a2, -244(sp) #save offset of Ti447.3275.7044.10448.15497
	fsw	fa1, -248(sp) #savef offset of Td450.3276.7045.10451.15500
	addi	t6, hp, 0
...
create_float_array_end.28336:
	...
	addi	a1, a1, 0
	lw	a1, 0(a1)
	sw	a0, -252(sp) #save offset of v3.3352.7121.10620.21723
	addi	t6, hp, 0
...
create_array_end.28337:
	...
	addi	hp, hp, 8
	sw	a0,4(a1) 
	lw	a0, -252(sp) #restore offset of v3.3352.7121.10620.21723
	sw	a0,0(a1) 
	addi	a2, a0, 0
	flw	fa0, -180(sp) # restoref offset of n0.3264.7033.10422.15471
	fsw	fa0, 0(a2) 
	...
	fsw	fa0, 0(a2) 
	addi	a0, a0, 8
	flw	fa0, -248(sp) # restoref offset of Td450.3276.7045.10451.15500
	fsw	fa0, 0(a0) 
	addi	a0, x0, 256
	addi	a0, a0, 0
	lw	a0, 0(a0)
	addi	a0, a0, -1
	sw	a1, -256(sp) #save offset of dvec.3307.7076.21728
	addi	t6, a1, 0
	addi	a1, a0, 0
	addi	a0, t6, 0
	sw	ra, -264(sp)
	...
	flw	fa0, -196(sp) # restoref offset of br.3263.7032.10418.15467
	fsw	fa0, 8(a0) 
	lw	a1, -256(sp) #restore offset of dvec.3307.7076.21728
	sw	a1,4(a0) 
	lw	a1, -244(sp) #restore offset of Ti447.3275.7044.10448.15497
	sw	a1,0(a0) 
	lw	a1, -240(sp) #restore offset of Ti445.3274.7043.10446.15495
	slli	a1, a1, 2
	addi	a1, a1, 1264
	sw	a0,0(a1) 
	addi	a0, x0, 1984
...
beq_else.28330:
	...
	addil	a3, a3, l.23583
	flw	fa4, 0(a3)
	sw	a2, -260(sp) #save offset of nr.3220.6989.10375.15424
	sw	a0, -264(sp) #save offset of sid.3219.6988.10372.15421
	fsw	fa0, -268(sp) #savef offset of br.3221.6990.10378.15427
	fsw	fa1, -272(sp) #savef offset of Td413.3230.6999.10405.15454
	fsw	fa3, -276(sp) #savef offset of Td405.3229.6998.10397.15446
	fsw	fa2, -280(sp) #savef offset of Td397.3228.6997.10389.15438
	addi	t6, hp, 0
...
create_float_array_end.28340:
	...
	addi	a1, a1, 0
	lw	a1, 0(a1)
	sw	a0, -284(sp) #save offset of v3.3352.7121.10620.21626
	addi	t6, hp, 0
...
create_array_end.28341:
	...
	addi	hp, hp, 8
	sw	a0,4(a1) 
	lw	a0, -284(sp) #restore offset of v3.3352.7121.10620.21626
	sw	a0,0(a1) 
	addi	a2, a0, 0
	flw	fa0, -280(sp) # restoref offset of Td397.3228.6997.10389.15438
	fsw	fa0, 0(a2) 
	addi	a2, a0, 4
	flw	fa0, -276(sp) # restoref offset of Td405.3229.6998.10397.15446
	fsw	fa0, 0(a2) 
	addi	a0, a0, 8
	flw	fa0, -272(sp) # restoref offset of Td413.3230.6999.10405.15454
	fsw	fa0, 0(a0) 
	addi	a0, x0, 256
	addi	a0, a0, 0
	lw	a0, 0(a0)
	addi	a0, a0, -1
	sw	a1, -288(sp) #save offset of dvec.3307.7076.21631
	addi	t6, a1, 0
	addi	a1, a0, 0
	addi	a0, t6, 0
	sw	ra, -296(sp)
	...
	addi	a0, hp 0
	addi	hp, hp, 12
	flw	fa0, -268(sp) # restoref offset of br.3221.6990.10378.15427
	fsw	fa0, 8(a0) 
	lw	a1, -288(sp) #restore offset of dvec.3307.7076.21631
	sw	a1,4(a0) 
	lw	a1, -264(sp) #restore offset of sid.3219.6988.10372.15421
	sw	a1,0(a0) 
	lw	a1, -260(sp) #restore offset of nr.3220.6989.10375.15424
	slli	a2, a1, 2
	addi	a2, a2, 1264
	sw	a0,0(a2) 
	addi	a0, x0, 1984
...
bg_cont.28325:
	...
	lw	a0, 0(a0)
	addi	a1, a0, -1
	lw	a0, -100(sp) #restore offset of cur.3163.6932.10202
	fsgnj	fs11, fa2, fa2
	fsgnj	fa2, fa0, fa0
	fsgnj	fa0, fa1, fa1
	fsgnj	fa1, fs11, fs11
	...
	addi	a0, x0, 0
	addi	a4, x0, 2
	lw	a1, -60(sp) #restore offset of prev.3162.6931.10200
	lw	a2, -100(sp) #restore offset of cur.3163.6932.10202
	lw	a3, -140(sp) #restore offset of next.3164.6933.10204
	lw	a5, -20(sp) #restore offset of Ti335.3156.6925
	sw	ra, -296(sp)
	addi	sp, sp, -300
